...
setlocal
set "SCRIPT_DIR=%~dp0"
set "LAUNCHER=%SCRIPT_DIR%dorka.exe"

if not exist "%LAUNCHER%" (
  echo Unable to locate the native Dorka CLI launcher at "%LAUNCHER%" 1>&2
  exit /b 1
)
...
:unsafe_body
echo dorka.cmd cannot safely forward orchestration message bodies. Use "%LAUNCHER%" instead. 1>&2
exit /b 2
