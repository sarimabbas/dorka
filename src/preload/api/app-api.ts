...
export type AppApi = {
  ...
  /** Restarts Dorka through the normal quit pipeline so daemon-backed terminal
  ...
  /** Emits a startup benchmark marker when DORKA_STARTUP_DIAGNOSTICS is enabled. */
  ...
  /** Resolves Dorka's app-owned directory for auto-created Floating Workspace
   *  markdown notes. */
