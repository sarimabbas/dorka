 ...
 */
import { GLIBC_FLOOR, nativeSlotName, type NativeHostAbi } from '../main/dorkad/native-host-abi'
import {
  classifyNodePtyLoaderMessage,
  isFlattenedNodePtyLoaderMessage
} from '../main/dorkad/node-pty-loader-diagnosis'
import {
  ...
  switch (diagnosis.reason) {
    ...
    case 'libc_floor':
      return (
        ...
        `node-pty here; Dorka's own Linux floor is glibc ${GLIBC_FLOOR}.`
      )
