...
export const FLAG_HELP_TEXT: Record<string, string> = {
  ...
  comment: '--comment <text>       Comment stored in Dorka metadata',
  ...
  activate: '--activate             Reveal the new worktree in the Dorka app',
  ...
  'display-name': '--display-name <name>  Override the Dorka display name',
  ...
  focus: '--focus                Reveal the created terminal session in Dorka',
  ...
  current: '--current              Use the current Dorka worktree linked Linear issue',
  ...
  page: '--page <id>            Stable browser page id from `dorka tab list --json`',
