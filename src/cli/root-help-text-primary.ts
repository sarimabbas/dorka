export const ROOT_HELP_TEXT_PRIMARY = [
  'dorka',
  '',
  'Usage: dorka <command> [options]',
  '',
  'Startup:',
  '  open                      Launch Dorka and wait for the runtime to be reachable',
  '  serve                     Start a headless Dorka runtime server',
  '  status                    Show app/runtime/graph readiness',
  '',
  'Diagnostics:',
  '  diagnostics memory        Collect a memory snapshot for Dorka and managed terminals',
  '',
  'Agent Discovery:',
  ...
  '  skills list               List version-matched skill guides bundled with this Dorka CLI',
  '  skills get                Print a version-matched skill guide as Markdown',
  '  skills install            Install bundled Dorka skills globally via the community skills CLI',
  '  skills update             Update already-installed Dorka skills via the community skills CLI',
  '',
  'Hosts:',
  '  host list                 List targetable machines and how to name each one',
  '',
  'Environments:',
  '  environment add           Save a remote Dorka runtime from a pairing code',
  '  environment list          List saved remote Dorka runtimes',
  '  environment show          Show one saved remote Dorka runtime',
  '  environment rm            Remove a saved remote Dorka runtime',
  '',
  'Environment Recipes:',
  '  vm recipe doctor          Validate a per-workspace environment recipe',
  '',
  'Automations:',
  '  automations list          List scheduled Dorka automations',
  '  automations show          Show one Dorka automation',
  '  automations create        Create a scheduled Dorka automation',
  '  automations edit          Edit an Dorka automation',
  '  automations remove        Remove an Dorka automation and its run history',
  '  automations run           Run an Dorka automation now',
  '  automations runs          List automation run history',
  '',
  'Projects:',
  '  project list              List durable projects known to Dorka',
  ...
  '',
  'Repos:',
  '  repo list                 List repos registered in Dorka',
  '  repo add                  Add a project to Dorka by filesystem path',
  ...
  '',
  'Worktrees:',
  '  worktree list             List Dorka-managed worktrees',
  '  worktree show             Show one worktree',
  '  worktree current          Show the Dorka-managed worktree for the current directory',
  '  worktree create           Create a new Dorka-managed worktree',
  '  worktree set              Update Dorka metadata for a worktree',
  '  worktree rm               Remove a worktree from Dorka and git',
  '  worktree ps               Show a compact orchestration summary across worktrees',
  '',
  'Files:',
  '  file open                 Open a workspace file in the Dorka editor',
  '  file diff                 Open a workspace file diff in the Dorka editor',
  '  file open-changed         Open all git-changed files for a workspace',
  '',
  'Terminals:',
  '  terminal list             List live Dorka-managed terminals',
  ...
  '  emulator list             List available/running emulators (Dorka-managed + raw serve-sim)',
