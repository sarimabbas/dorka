...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'dorka orchestration run-create --objective <text> [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration run-use --id <run_id> [--from <handle>] [--takeover-legacy] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration send --subject <text> [--to <run:id|dispatch:id|legacy_handle>] [--run <run_id>] [--from <handle>] [--body <text>] [--type <type>] [--priority <level>] [--thread-id <id>] [--payload <json>] [--task-id <id>] [--dispatch-id <id>] [--outcome <succeeded|failed>] [--files-modified <csv>] [--report-path <path>] [--phase <text>] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
    ...
    notes: [
      ...
      'Use --to dispatch:<id> for attempt-specific coordinator guidance; Dorka durably relays it to a connected worker server.',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration check [--terminal <handle>] [--run <run_id>] [--ack <delivery_id>] [--unread | --peek | --all] [--types <type,...>] [--format] [--wait] [--timeout-ms <n>] [--retry-request <id>] [--json]\n' +
  ...
  },
  {
    ...
    usage:
      'dorka orchestration reply --id <msg_id> --body <text> [--run <run_id>] [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'dorka orchestration inbox [--limit <n>] [--terminal <handle>] [--full] [--json]',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration task-create --spec <text> [--task-title <text>] [--display-name <text>] [--deps <json_array>] [--parent <task_id>] [--run <run_id>] [--from <handle>] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'task-title',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration task-list [--status <status>] [--ready] [--brief] [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration task-update --id <task_id> --status <status> [--result <json>] [--run <run_id>] [--from <handle>] [--retry-request <id>] [--json]',
  ...
  ...ORCHESTRATION_WORKER_COMMAND_SPECS,
  {
    ...
    usage:
      'dorka orchestration dispatch --task <task_id> --to <handle> [--from <handle>] [--run <run_id>] [--inject] [--dry-run] [--return-preamble] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'task',
      'to',
  ...
  },
  {
    ...
    usage: 'dorka orchestration request-show --request <request_id> [--json]',
    ...
    notes: [
      ...
      'completed means the mutation landed and --retry-request replays the recorded outcome instead of starting a second one. pending means the original mutation is still running or Dorka restarted before recording its outcome; wait for a live original command, otherwise replay with --retry-request.',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration dispatch-show --task <task_id> [--preamble] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration ask (--question <text> | --resume <message_id>) [--to <run:id>] [--run <run_id>] [--options <csv>] [--timeout-ms <n>] [--from <handle>] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration coordinator-start --spec <text> [--from <handle>] [--poll-interval-ms <n>] [--max-concurrent <n>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'from',
  ...
  },
  {
    ...
    summary: 'Retired: load the current orchestration skill',
    usage: 'dorka orchestration coordinator-stop [--json]',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration gate-create --task <task_id> --question <text> [--options <json_array>] [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration gate-resolve --id <gate_id> --resolution <text> [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration gate-list [--task <task_id>] [--status <status>] [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'dorka orchestration reset (--all | --tasks | --messages) [--retry-request <id>] [--json]',
