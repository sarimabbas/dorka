...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start an Dorka runtime server without opening a desktop window',
    usage:
    ...
    examples: [
      'dorka serve',
      'dorka serve --json',
      'dorka serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'dorka serve --port 6768 --pairing-address 100.64.1.20',
      'dorka serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
