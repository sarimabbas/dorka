...
describe('skill command specs', () => {
  ...
  it('documents the per-reference selector beside --full', () => {
    ...
    expect(help).toContain('Usage: dorka skills get <topic> [--full | --reference <name>] [--json]')
    ...
    expect(help).toContain('dorka skills get orchestration --reference recovery-and-cleanup')
