...
export const LINEAR_MCP_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'dorka linear save-issue [<id>] [--current] [--team <key|id>] [--title <title>] [--description <text> | --body-file <path|->] [--state <state>] [--assignee me|<user>|null] [--priority none|low|medium|high|urgent] [--estimate <number>|null] [--due-date <yyyy-mm-dd>|null] [--label <label>...] [--project <project>|null] [--parent-id <issue>|null] [--write-id <uuid>] [--workspace <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'current',
      'team',
    ...
    positionalArgs: ['id'],
    examples: [
      'dorka linear save-issue --team ENG --title "Fix auth" --priority high --json',
      'dorka linear save-issue ENG-123 --title "Fix OAuth callback" --assignee me --json',
      'dorka linear save-issue --current --project null --due-date null --json'
    ],
    notes: [
  ...
  },
  {
    ...
    examples: [
      'dorka linear list-issues --team ENG --state started --assignee me --json',
      'dorka linear list-issues --query auth --updated-at -P7D --json',
      'dorka linear list-issues --assignee me --priority 1 --limit 100 --json',
      'dorka linear list-issues --cursor <cursor> --json'
    ],
    notes: [
  ...
  },
  {
    ...
    usage:
      'dorka linear relation add [<id>] [--current] --related <issue> --type blocks|blocked-by|related|duplicate-of [--workspace <id>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'related', 'type', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: [
      'dorka linear relation add ENG-1 --related ENG-2 --type blocks --json',
      'dorka linear relation add --current --related ENG-2 --type blocked-by --json'
    ]
  },
  {
    ...
    usage:
      'dorka linear relation remove [<id>] [--current] --related <issue> --type blocks|blocked-by|related|duplicate-of [--workspace <id>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'related', 'type', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['dorka linear relation remove ENG-1 --related ENG-2 --type related --json']
  }
]
