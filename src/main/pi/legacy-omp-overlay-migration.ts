...
import { DORKA_PI_AGENT_STATUS_EXTENSION_FILE } from './agent-status-extension-source'
import { DORKA_PI_PREFILL_EXTENSION_FILE } from './prefill-extension-source'
import { DORKA_PI_EXTENSION_FILE } from './titlebar-extension-source'
import { isSafeDescendCandidate } from '../pty/overlay-mirror'

const LEGACY_PI_OVERLAY_MANIFEST_FILE = '.dorka-pi-overlay-manifest.json'
const LEGACY_OMP_OVERLAY_MIGRATION_MARKER_FILE = '.dorka-omp-overlay-migration-complete'
