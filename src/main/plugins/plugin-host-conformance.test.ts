...
const PLUGIN_KEY = 'dorka-samples.demo'
const WORKTREE_ID = 'repo-id::/Users/private/dorka'
...
function createServices(): PluginHostServices {
  return {
    resolveActiveWorktreeContext: vi.fn().mockResolvedValue({
      ...
      branch: 'main',
      displayName: 'Dorka',
      path: '/Users/private/dorka'
    }),
    listWorktreeTerminals: vi
      .fn()
      .mockResolvedValue([{ id: TERMINAL_ID, title: '/home/private/dorka' }]),
