...
export function registerAutoUpdaterHandlers({
  ...
  autoUpdater.on('update-available', (info) => {
    ...
    // Why: fetch the changelog in main to avoid renderer-side CORS on ondorka.dev.
  ...
  autoUpdater.on('update-not-available', () => {
    ...
    // the user to install it outside Dorka. Keep both the artifact and its recovery card reachable.
    sendStatus(
