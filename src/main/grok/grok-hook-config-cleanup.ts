...
// Why not "the whole object is empty": dorka-status.json is Dorka-owned, so once no hook entries
...
export function isDorkaOwnedRemnant(config: HooksConfig): boolean {
