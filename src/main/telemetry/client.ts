...
const WRITE_KEY: string | null =
  typeof DORKA_POSTHOG_WRITE_KEY !== 'undefined'
    ...
    : ((globalThis as { DORKA_POSTHOG_WRITE_KEY?: string | null }).DORKA_POSTHOG_WRITE_KEY ?? null)
...
// No-op in contributor / non-official builds; only official stable/rc builds (CI-injected `DORKA_BUILD_IDENTITY` + `DORKA_POSTHOG_WRITE_KEY`) transmit.
