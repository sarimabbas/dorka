...
export const TEST_REPO_DORKA_YAML_PATH = join(TEST_REPO_PATH, 'dorka.yaml')
export const TEST_WORKTREE_DORKA_YAML_PATH = join(TEST_WORKTREE_PATH, 'dorka.yaml')
export const TEST_ISSUE_COMMAND_PATH = join(TEST_REPO_PATH, '.dorka', 'issue-command')
