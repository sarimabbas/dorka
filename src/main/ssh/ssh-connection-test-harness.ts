...
export type SystemFallbackModuleMock = {
  getDorkaControlSocketPath: typeof getDorkaControlSocketPathMock
...
export const getDorkaControlSocketPathMock =
...
export function createSystemFallbackModule(): SystemFallbackModuleMock {
  return {
    getDorkaControlSocketPath: getDorkaControlSocketPathMock,
...
export function resetSshConnectionMocks(): void {
  resetSsh2ClientState()
  getDorkaControlSocketPathMock.mockReset()
