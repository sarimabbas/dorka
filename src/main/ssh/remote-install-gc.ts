/**
 * The version-directory garbage collector, shared by the relay and dorkad.
 *
...
// eventually drain. There is no dorkad equivalent — dorkad has never shipped without one.
...
export type RemoteInstallGcOptions = {
   ...
   * (not absolute path). dorkad passes its active and previous versions: the previous one is
