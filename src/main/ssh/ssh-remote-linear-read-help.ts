...
const LINEAR_HELP = `dorka linear

Usage: dorka linear <command> [options]
...
Run \`dorka linear <command> --help\` for command-specific usage.`

const LINEAR_ISSUE_HELP = `dorka linear issue

Usage: dorka linear issue [<id>] [--current] [--comments] [--children] [--depth <n>] [--attachments] [--relations] [--activity] [--full] [--workspace <id>] [--json]
...
Options:
  ...
  --pairing-code
  --environment
  --current              Use the current Dorka worktree linked Linear issue
...
Examples:
  $ dorka linear search "auth bug"
  $ dorka linear search ENG --workspace all --json`

const LINEAR_TEAM_LIST_HELP = `dorka linear team list

Usage: dorka linear team list [--workspace <id>|all] [--json]

List connected Linear teams`

const LINEAR_TEAM_MEMBERS_HELP = `dorka linear team members

Usage: dorka linear team members --team <key|id> [--workspace <id>] [--json]

List Linear team members`

const LINEAR_TEAM_STATES_HELP = `dorka linear team states

Usage: dorka linear team states --team <key|id> [--workspace <id>] [--json]

List Linear team workflow states`

const LINEAR_TEAM_LABELS_HELP = `dorka linear team labels

Usage: dorka linear team labels --team <key|id> [--workspace <id>] [--json]

List Linear team labels`

const LINEAR_PROJECT_LIST_HELP = `dorka linear project list

Usage: dorka linear project list [--query <text>] [--limit <n>] [--workspace <id>|all] [--json]

List connected Linear projects`

const LINEAR_LIST_HELP = `dorka linear list

Usage: dorka linear list [--filter assigned|created|all|completed|open] [--team <key|id>] [--limit <n>] [--workspace <id>|all] [--json]
