...
export async function acknowledgeRemoteDorkaCliPostOutput(
...
export function parseRemoteDorkaCliPostOutput(value: unknown): RemoteDorkaCliPostOutput {
...
): RemoteDorkaCliPostOutput | undefined {
