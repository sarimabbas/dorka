...
export const RELAY_REMOTE_DIR = '.dorka-remote'
...
export function isGitResponseStreamMarker(value: unknown): value is GitResponseStreamMarker {
  if (typeof value !== 'object' || value === null || !('__dorkaGitResponseStream' in value)) {
    return false
  }
  const marker = (value as { __dorkaGitResponseStream?: unknown }).__dorkaGitResponseStream
