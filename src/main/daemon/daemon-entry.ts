...
async function main(): Promise<void> {
  ...
  const e2eProbeFile = process.env.DORKA_E2E_LOGIN_SESSION_PROBE_FILE
...
// load check — see config/scripts/build-dorkad.mjs).
const isDirectExecution = !process.env.VITEST && !process.env.DORKA_DAEMON_ENTRY_LOAD_CHECK
