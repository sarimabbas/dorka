...
// daemon-side fact authority): DORKA_DAEMON_BACKGROUND_STREAM_DROP=0.
export const BACKGROUND_STREAM_DROP_ENABLED = process.env.DORKA_DAEMON_BACKGROUND_STREAM_DROP !== '0'
