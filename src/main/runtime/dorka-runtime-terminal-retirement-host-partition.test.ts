...
function syncSshSplit(runtime: DorkaRuntimeService, snapshot: RuntimeMobileSessionTabsSnapshot) {
...
describe('DorkaRuntimeService terminal retirement host partitioning (STA-3463)', () => {
  ...
  it('waits for provider retirement on a direct worktree stop', async () => {
    ...
    const runtime = new DorkaRuntimeService(harness.store)
