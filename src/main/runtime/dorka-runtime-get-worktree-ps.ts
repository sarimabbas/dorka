...
import { DorkaRuntimeWithStructuredAgentSessionRecoverTuiOwner } from './dorka-runtime-structured-agent-session-recover-tui-owner'
import { DEFAULT_WORKTREE_PS_LIMIT } from './dorka-runtime-postlude'
...
export class DorkaRuntimeWithGetWorktreePs extends DorkaRuntimeWithStructuredAgentSessionRecoverTuiOwner {
  async getWorktreePs(
