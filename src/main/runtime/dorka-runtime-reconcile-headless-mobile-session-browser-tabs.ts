...
import { DorkaRuntimeWithHydrateHeadlessMobileSessionTabsFromWorkspaceSession } from './dorka-runtime-hydrate-headless-mobile-session-tabs-from-workspace-session'
import type {
...
import { SSH_PANE_RECOVERY_GRACE_MS } from './dorka-runtime-core'
import { findTerminalTabIdForLeaf } from './workspace-session-terminal-membership-authority'

export class DorkaRuntimeWithReconcileHeadlessMobileSessionBrowserTabs extends DorkaRuntimeWithHydrateHeadlessMobileSessionTabsFromWorkspaceSession {
