...
function makeRuntime(): { runtime: DorkaRuntimeService; writes: string[] } {
  const writes: string[] = []
...
function syncGraph(runtime: DorkaRuntimeService): void {
...
function register(runtime: DorkaRuntimeService, incarnationId: string): void {
