...
import { DorkaRuntimeWithPersistHeadlessSessionTabProps } from './dorka-runtime-persist-headless-session-tab-props'
import type {
...
export class DorkaRuntimeWithMoveHeadlessMobileSessionTab extends DorkaRuntimeWithPersistHeadlessSessionTabProps {
