...
export function terminalShellOverrideRefusal(args: {
  ...
  if (args.connectionId) {
    ...
    return new Error(
      `This workspace runs its terminals over SSH, and Dorka cannot apply --shell ${args.shellOverride} there. No terminal was created. Omit --shell, or create the terminal on the execution host itself.`
    )
  }
