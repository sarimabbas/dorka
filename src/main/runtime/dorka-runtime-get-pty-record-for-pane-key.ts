...
import { DorkaRuntimeWithPruneMobileSessionTabGroupLayout } from './dorka-runtime-prune-mobile-session-tab-group-layout'
...
export class DorkaRuntimeWithGetPtyRecordForPaneKey extends DorkaRuntimeWithPruneMobileSessionTabGroupLayout {
