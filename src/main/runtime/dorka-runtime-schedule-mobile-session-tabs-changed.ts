...
import { DorkaRuntimeWithStoredMobileSnapshotHasStalePreservedTab } from './dorka-runtime-stored-mobile-snapshot-has-stale-preserved-tab'
import type {
  BrowserTabInfo,
...
export class DorkaRuntimeWithScheduleMobileSessionTabsChanged extends DorkaRuntimeWithStoredMobileSnapshotHasStalePreservedTab {
