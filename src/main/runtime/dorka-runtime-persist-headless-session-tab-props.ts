...
import { DorkaRuntimeWithCloseHeadlessMobileTerminalTab } from './dorka-runtime-close-headless-mobile-terminal-tab'
...
export class DorkaRuntimeWithPersistHeadlessSessionTabProps extends DorkaRuntimeWithCloseHeadlessMobileTerminalTab {
