...
import { DorkaRuntimeWithGetUnpersistedTrackedTitleForPty } from './dorka-runtime-get-unpersisted-tracked-title-for-pty'
...
export class DorkaRuntimeWithApplyTrackedPtyTitle extends DorkaRuntimeWithGetUnpersistedTrackedTitleForPty {
