...
import { DorkaRuntimeWithGetStatus } from './dorka-runtime-get-status'
...
export class DorkaRuntimeWithNotifySshStateChanged extends DorkaRuntimeWithGetStatus {
  ...
  protected bumpSshRelayRecoveryGeneration(targetId: string): number {
    ...
    while (
      ...
      DorkaRuntimeWithNotifySshStateChanged.MAX_SSH_RELAY_RECOVERY_GENERATIONS
    ) {
