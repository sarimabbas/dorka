...
import { DorkaRuntimeWithRefuseUnattributedMobileSessionTabClose } from './dorka-runtime-refuse-unattributed-mobile-session-tab-close'
import type {
...
export class DorkaRuntimeWithCloseMobileSessionTab extends DorkaRuntimeWithRefuseUnattributedMobileSessionTabClose {
