...
import { DorkaRuntimeWithWriteTerminalAgentPrompt } from './dorka-runtime-write-terminal-agent-prompt'
import {
...
export class DorkaRuntimeWithCreateAgentPromptRenderGate extends DorkaRuntimeWithWriteTerminalAgentPrompt {
