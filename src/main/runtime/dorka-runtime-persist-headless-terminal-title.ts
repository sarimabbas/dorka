...
import { DorkaRuntimeWithMoveHeadlessMobileSessionTab } from './dorka-runtime-move-headless-mobile-session-tab'
import type {
...
export class DorkaRuntimeWithPersistHeadlessTerminalTitle extends DorkaRuntimeWithMoveHeadlessMobileSessionTab {
