...
import { DorkaRuntimeWithProveRecoveredStructuredTuiPtyProcess } from './dorka-runtime-prove-recovered-structured-tui-pty-process'
...
import { isPathWithinDirectory } from './dorka-runtime-core'

export class DorkaRuntimeWithStopStructuredSessionProcess extends DorkaRuntimeWithProveRecoveredStructuredTuiPtyProcess {
