...
import { DorkaRuntimeWithResolveAuthoritativeTerminalWaitPermission } from './dorka-runtime-resolve-authoritative-terminal-wait-permission'
...
export class DorkaRuntimeWithWriteTerminalAgentPrompt extends DorkaRuntimeWithResolveAuthoritativeTerminalWaitPermission {
  protected async writeTerminalAgentPrompt(
    ...
    // receipt; they must not fail a Dispatch merely because Dorka cannot prove
