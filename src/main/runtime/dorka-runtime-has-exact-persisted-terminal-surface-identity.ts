...
import { DorkaRuntimeWithAutomationOperations } from './dorka-runtime-automation-operations'
import {
...
export class DorkaRuntimeWithHasExactPersistedTerminalSurfaceIdentity extends DorkaRuntimeWithAutomationOperations {
