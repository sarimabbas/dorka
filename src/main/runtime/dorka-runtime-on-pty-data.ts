...
import { DorkaRuntimeWithPreparePtyExecutionContext } from './dorka-runtime-prepare-pty-execution-context'
...
export class DorkaRuntimeWithOnPtyData extends DorkaRuntimeWithPreparePtyExecutionContext {
  onPtyData(
    ptyId: string,
    data: string,
    at: number,
