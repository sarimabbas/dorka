/**
 * Drives the real push seam: a real DorkaRuntimeService, the real lease registry, the real page
...
function attachHost(runtime: DorkaRuntimeService, browserHostClientId: string) {
