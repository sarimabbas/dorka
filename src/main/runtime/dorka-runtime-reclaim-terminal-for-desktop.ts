...
import { DorkaRuntimeWithMobileTookFloor } from './dorka-runtime-mobile-took-floor'
import {
  MOBILE_AUTO_RESTORE_FIT_MAX_MS,
  MOBILE_AUTO_RESTORE_FIT_MIN_MS
} from './dorka-runtime-postlude'

export class DorkaRuntimeWithReclaimTerminalForDesktop extends DorkaRuntimeWithMobileTookFloor {
