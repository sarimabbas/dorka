import { DorkaRuntimeWithSerializeAgentPromptSubmission } from './dorka-runtime-serialize-agent-prompt-submission'
...
export class DorkaRuntimeWithAgentPromptRequestCorrelation extends DorkaRuntimeWithSerializeAgentPromptSubmission {
