...
import { DorkaRuntimeWithSerializeTerminalBufferFromAvailableState } from './dorka-runtime-serialize-terminal-buffer-from-available-state'
...
import type { RuntimeTerminalProjection } from './dorka-runtime-core'
import { DEFAULT_TERMINAL_READ_LIMIT } from './terminal-tail-limits'
import { HeadlessEmulator } from '../daemon/headless-emulator'
import { projectTerminalTailLines } from './dorka-runtime-terminal-projection'

export class DorkaRuntimeWithCaptureProviderTerminalBuffer extends DorkaRuntimeWithSerializeTerminalBufferFromAvailableState {
