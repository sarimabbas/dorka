...
import { DorkaRuntimeWithAgentPromptRequestCorrelation } from './dorka-runtime-agent-prompt-request-correlation'
...
export class DorkaRuntimeWithResolveAuthoritativeTerminalWaitPermission extends DorkaRuntimeWithAgentPromptRequestCorrelation {
