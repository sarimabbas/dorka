...
import { DorkaRuntimeWithSyncMobileSessionTabs } from './dorka-runtime-sync-mobile-session-tabs'
import type {
...
export class DorkaRuntimeWithMergePreservedHeadlessMobileSessionTabs extends DorkaRuntimeWithSyncMobileSessionTabs {
