...
/**
 * Faithful double of the runtime subscription registry (`DorkaRuntimeService`,
 ...
 * `dorka-runtime.test.ts` are what pin the real behavior; these doubles only pin routing.
 *
