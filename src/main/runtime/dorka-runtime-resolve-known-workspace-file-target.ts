...
import { DorkaRuntimeWithPersistHeadlessTerminalTitle } from './dorka-runtime-persist-headless-terminal-title'
import {
...
export class DorkaRuntimeWithResolveKnownWorkspaceFileTarget extends DorkaRuntimeWithPersistHeadlessTerminalTitle {
  ...
  // RPC, but agents need their own handle at spawn time (via DORKA_TERMINAL_HANDLE
  ...
  protected adoptControllerTerminalHandle(
    ...
    // original DORKA_TERMINAL_HANDLE, but the runtime's in-memory map is gone.
