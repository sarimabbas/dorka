...
import { DorkaRuntimeWithFocusTerminal } from './dorka-runtime-focus-terminal'
...
export class DorkaRuntimeWithStopExplicitlyClosedTabPtys extends DorkaRuntimeWithFocusTerminal {
