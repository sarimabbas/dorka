...
import { DorkaRuntimeWithStartTuiIdleVisibleReadProbe } from './dorka-runtime-start-tui-idle-visible-read-probe'
...
export class DorkaRuntimeWithStructuredAgentSessionLaunchTui extends DorkaRuntimeWithStartTuiIdleVisibleReadProbe {
