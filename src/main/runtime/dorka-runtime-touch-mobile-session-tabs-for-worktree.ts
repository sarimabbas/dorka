...
import { DorkaRuntimeWithPublishPtyBackedMobileSessionTerminal } from './dorka-runtime-publish-pty-backed-mobile-session-terminal'
...
export class DorkaRuntimeWithTouchMobileSessionTabsForWorktree extends DorkaRuntimeWithPublishPtyBackedMobileSessionTerminal {
