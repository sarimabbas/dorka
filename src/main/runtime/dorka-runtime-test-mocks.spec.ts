...
import * as setup from './dorka-runtime-test-mocks/setup.spec'
import * as importedValues from './dorka-runtime-test-mocks/imported-values.spec'
...
export const DorkaRuntimeService = importedValues.exportedDorkaRuntimeService
...
export const parseDorkaYaml = importedValues.exportedParseDorkaYaml
...
} from './dorka-runtime-test-mocks/setup.spec'
...
export { electronMocks } from './dorka-runtime-test-mocks/setup.spec'
export {
...
export type DorkaRuntimeService = InstanceType<typeof importedValues.exportedDorkaRuntimeService>
...
export type { RuntimeTerminalAgentStatusEvent } from './dorka-runtime'
