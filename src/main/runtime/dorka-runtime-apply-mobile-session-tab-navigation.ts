...
import { DorkaRuntimeWithPerformMobileSessionPtyRecordsRefresh } from './dorka-runtime-perform-mobile-session-pty-records-refresh'
import type {
...
export class DorkaRuntimeWithApplyMobileSessionTabNavigation extends DorkaRuntimeWithPerformMobileSessionPtyRecordsRefresh {
