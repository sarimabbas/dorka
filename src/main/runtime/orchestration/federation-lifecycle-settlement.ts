...
const waitersByRuntime = new WeakMap<DorkaRuntimeService, Map<string, Set<Waiter>>>()
...
function getRuntimeWaiters(runtime: DorkaRuntimeService): Map<string, Set<Waiter>> {
