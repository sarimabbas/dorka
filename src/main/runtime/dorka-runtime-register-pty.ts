...
import { DorkaRuntimeWithInvalidateAllHandlesForPty } from './dorka-runtime-invalidate-all-handles-for-pty'
...
export class DorkaRuntimeWithRegisterPty extends DorkaRuntimeWithInvalidateAllHandlesForPty {
  registerPty(
    ptyId: string,
    worktreeId: string,
