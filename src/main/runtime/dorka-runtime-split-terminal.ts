...
import { DorkaRuntimeWithStopExplicitlyClosedTabPtys } from './dorka-runtime-stop-explicitly-closed-tab-ptys'
import type { TerminalPaneSplitSource } from '../../shared/feature-education-telemetry'
import type { RuntimeTerminalSplit } from '../../shared/runtime-types'
import { randomUUID } from 'node:crypto'

export class DorkaRuntimeWithSplitTerminal extends DorkaRuntimeWithStopExplicitlyClosedTabPtys {
  async splitTerminal(
    handle: string,
    opts: {
