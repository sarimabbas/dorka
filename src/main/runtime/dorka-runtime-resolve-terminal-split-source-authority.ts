...
import { DorkaRuntimeWithSplitPtyBackedTerminal } from './dorka-runtime-split-pty-backed-terminal'
import {
...
export class DorkaRuntimeWithResolveTerminalSplitSourceAuthority extends DorkaRuntimeWithSplitPtyBackedTerminal {
  ...
  async prepareClaudeAgentTeamsLeader(args: {
    ...
    if (!handle) {
      throw new Error('claude_agent_teams_requires_dorka_terminal')
    }
