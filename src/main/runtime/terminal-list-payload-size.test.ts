...
const WORKTREE_PATH = '/Users/dev/dorka/workspaces/dorka/perf-terminal-list-diet'
...
const titleFor = (index: number): string => `claude — dorka/perf-terminal-list-diet #${index}`
...
function buildLoadedRuntime(): DorkaRuntimeService {
