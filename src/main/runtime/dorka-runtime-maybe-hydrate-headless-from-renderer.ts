...
import { DorkaRuntimeWithSerializeMainTerminalBuffer } from './dorka-runtime-serialize-main-terminal-buffer'
...
export class DorkaRuntimeWithMaybeHydrateHeadlessFromRenderer extends DorkaRuntimeWithSerializeMainTerminalBuffer {
