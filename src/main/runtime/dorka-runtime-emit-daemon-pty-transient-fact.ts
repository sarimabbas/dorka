...
export class DorkaRuntimeWithEmitDaemonPtyTransientFact extends DorkaRuntimeWithScheduleWaitBlockedCheck {
  ...
  getTerminalSideEffectSnapshot(ptyId: string): TerminalSideEffectBatch | null {
    ...
    // tracker title Dorka synthesized from hooks — but with no tracker title it is the pane's
