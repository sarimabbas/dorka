...
import { DorkaRuntimeWithApplyTrackedPtyTitle } from './dorka-runtime-apply-tracked-pty-title'
import type {
...
export class DorkaRuntimeWithCreateTerminalSideEffectCommandCodeDetector extends DorkaRuntimeWithApplyTrackedPtyTitle {
