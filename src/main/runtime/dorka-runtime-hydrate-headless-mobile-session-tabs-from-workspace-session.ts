...
import { DorkaRuntimeWithWaitForSessionTabsInventoryPublication } from './dorka-runtime-wait-for-session-tabs-inventory-publication'
...
export class DorkaRuntimeWithHydrateHeadlessMobileSessionTabsFromWorkspaceSession extends DorkaRuntimeWithWaitForSessionTabsInventoryPublication {
