...
import { DorkaRuntimeWithDeliverPendingMessages } from './dorka-runtime-deliver-pending-messages'
...
export class DorkaRuntimeWithResolveWaiter extends DorkaRuntimeWithDeliverPendingMessages {
