...
import { DorkaRuntimeWithAdoptTerminalOrphansFromInventory } from './dorka-runtime-adopt-terminal-orphans-from-inventory'
import type {
...
import { TERMINAL_INTERACTIVE_WAIT_PROBE_TIMEOUT_MS } from './dorka-runtime-core'
...
export class DorkaRuntimeWithGetTerminalInteractiveWait extends DorkaRuntimeWithAdoptTerminalOrphansFromInventory {
