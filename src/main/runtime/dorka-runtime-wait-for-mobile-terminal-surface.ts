...
import { DorkaRuntimeWithCreateRuntimeOwnedMobileSessionTerminal } from './dorka-runtime-create-runtime-owned-mobile-session-terminal'
import type {
  RuntimeMobileSessionCreateTerminalResult,
  RuntimeMobileSessionTerminalClientTab
} from '../../shared/runtime-types'
import { MOBILE_TERMINAL_SURFACE_TIMEOUT_MS } from './dorka-runtime-core'
...
export class DorkaRuntimeWithWaitForMobileTerminalSurface extends DorkaRuntimeWithCreateRuntimeOwnedMobileSessionTerminal {
