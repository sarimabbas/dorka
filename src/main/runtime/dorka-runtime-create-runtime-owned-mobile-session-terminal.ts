...
import { DorkaRuntimeWithResolveMobileSessionTerminalCommand } from './dorka-runtime-resolve-mobile-session-terminal-command'
...
export class DorkaRuntimeWithCreateRuntimeOwnedMobileSessionTerminal extends DorkaRuntimeWithResolveMobileSessionTerminalCommand {
