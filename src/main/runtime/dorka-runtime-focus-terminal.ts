...
import { DorkaRuntimeWithWaitForLeafPtyId } from './dorka-runtime-wait-for-leaf-pty-id'
...
export class DorkaRuntimeWithFocusTerminal extends DorkaRuntimeWithWaitForLeafPtyId {
  async focusTerminal(
    handle: string,
