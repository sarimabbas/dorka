...
import { DorkaRuntimeWithResolveTerminalPane } from './dorka-runtime-resolve-terminal-pane'
import { PROVEN_ABSENT_LEAF_PTY_TTL_MS } from './dorka-runtime-core'
...
export class DorkaRuntimeWithControllerKnowsPtyIsLive extends DorkaRuntimeWithResolveTerminalPane {
