...
import { DorkaRuntimeWithStateFields } from './dorka-runtime-state-fields'
import {
...
export class DorkaRuntimeWithPtyForegroundProcessReads extends DorkaRuntimeWithStateFields {
