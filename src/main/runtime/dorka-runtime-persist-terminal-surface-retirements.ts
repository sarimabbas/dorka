...
import { DorkaRuntimeWithTouchMobileSessionTabsForWorktree } from './dorka-runtime-touch-mobile-session-tabs-for-worktree'
...
export class DorkaRuntimeWithPersistTerminalSurfaceRetirements extends DorkaRuntimeWithTouchMobileSessionTabsForWorktree {
  /**
