...
describe('DorkaRuntimeService', () => {
  ...
  describe('stale terminal handle resolution (#7718)', () => {
    function syncSingleTerminalGraph(runtime: DorkaRuntimeService, ptyId: string): void {
    ...
    function issueLeafHandle(runtime: DorkaRuntimeService, ptyId: string): string {
