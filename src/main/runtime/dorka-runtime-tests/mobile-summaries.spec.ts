...
import { DorkaRuntimeService, listWorktrees } from '../dorka-runtime-test-mocks.spec'
import {
  HEADLESS_LEAF_ID,
...
describe('DorkaRuntimeService', () => {
  ...
  it('attaches inline agent rows from the latest OSC 9999 status', async () => {
    const runtime = new DorkaRuntimeService(store, undefined, makeAgentStatusStoreWiring().deps)
