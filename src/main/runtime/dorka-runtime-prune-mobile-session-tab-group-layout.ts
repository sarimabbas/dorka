...
import { DorkaRuntimeWithScheduleMobileSessionTabsChanged } from './dorka-runtime-schedule-mobile-session-tabs-changed'
...
export class DorkaRuntimeWithPruneMobileSessionTabGroupLayout extends DorkaRuntimeWithScheduleMobileSessionTabsChanged {
