...
import { DorkaRuntimeWithPtyForegroundProcessReads } from './dorka-runtime-pty-foreground-process-reads'
import type {
...
export class DorkaRuntimeWithAutomationOperations extends DorkaRuntimeWithPtyForegroundProcessReads {
