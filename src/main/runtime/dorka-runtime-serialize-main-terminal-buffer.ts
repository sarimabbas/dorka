...
import { DorkaRuntimeWithAttachRemoteTerminalSourceRangeConsumer } from './dorka-runtime-attach-remote-terminal-source-range-consumer'
...
export class DorkaRuntimeWithSerializeMainTerminalBuffer extends DorkaRuntimeWithAttachRemoteTerminalSourceRangeConsumer {
  ...
  // Why: daemon-backed PTYs that the runtime adopted after an Dorka relaunch
