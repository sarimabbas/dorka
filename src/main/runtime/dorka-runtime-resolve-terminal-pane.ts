...
import { DorkaRuntimeWithGetTerminalInteractiveWait } from './dorka-runtime-get-terminal-interactive-wait'
import type {
  RuntimeTerminalRead,
...
export class DorkaRuntimeWithResolveTerminalPane extends DorkaRuntimeWithGetTerminalInteractiveWait {
