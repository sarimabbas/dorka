...
import { DorkaRuntimeWithApplyMobileDisplayMode } from './dorka-runtime-apply-mobile-display-mode'
...
export class DorkaRuntimeWithSubscribeToTerminalResize extends DorkaRuntimeWithApplyMobileDisplayMode {
