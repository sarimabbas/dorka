...
import { DorkaRuntimeWithRefreshFloatingWorkspacePtyLiveness } from './dorka-runtime-refresh-floating-workspace-pty-liveness'
...
export class DorkaRuntimeWithWriteOrchestrationPointerPty extends DorkaRuntimeWithRefreshFloatingWorkspacePtyLiveness {
