...
import { DorkaRuntimeWithMergePreservedHeadlessMobileSessionTabs } from './dorka-runtime-merge-preserved-headless-mobile-session-tabs'
import type {
...
export class DorkaRuntimeWithStoredMobileSnapshotHasStalePreservedTab extends DorkaRuntimeWithMergePreservedHeadlessMobileSessionTabs {
