...
import { DorkaRuntimeWithHandleMobileUnsubscribe } from './dorka-runtime-handle-mobile-unsubscribe'

export class DorkaRuntimeWithApplyMobileDisplayMode extends DorkaRuntimeWithHandleMobileUnsubscribe {
