...
export class DorkaRuntimeWithRuntimeId {
  ...
  /** The agent Dorka believes owns this pane, for tui-idle evidence ranking. Launch
   *  authority first; the live foreground agent covers panes Dorka did not launch. */
