...
import { DorkaRuntimeWithControllerKnowsPtyIsLive } from './dorka-runtime-controller-knows-pty-is-live'
...
export class DorkaRuntimeWithSerializeAgentPromptSubmission extends DorkaRuntimeWithControllerKnowsPtyIsLive {
