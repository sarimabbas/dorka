...
import { DorkaRuntimeWithCreateAgentPromptRenderGate } from './dorka-runtime-create-agent-prompt-render-gate'
import type {
...
export class DorkaRuntimeWithStartTuiIdleVisibleReadProbe extends DorkaRuntimeWithCreateAgentPromptRenderGate {
