...
import { DorkaRuntimeWithCloseMobileSessionTab } from './dorka-runtime-close-mobile-session-tab'
import type {
...
export class DorkaRuntimeWithCloseStructuredAgentSessionTab extends DorkaRuntimeWithCloseMobileSessionTab {
