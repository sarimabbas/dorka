...
import { DorkaRuntimeWithSyncWindowGraph } from './dorka-runtime-sync-window-graph'
...
export class DorkaRuntimeWithCollectMobileVisibleGraphChangedWorktrees extends DorkaRuntimeWithSyncWindowGraph {
  ...
  supportsAuthoritativeSessionTabsInventory(): boolean {
    return process.env.DORKA_E2E_DISABLE_AUTHORITATIVE_SESSION_TABS_INVENTORY !== '1'
  }
