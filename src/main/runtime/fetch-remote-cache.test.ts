...
// `DorkaRuntimeService.fetchRemoteWithCache` — in particular that a rejected
...
// without disturbing the large dorka-runtime.test.ts mock surface.
...
// Why: dorka-runtime.ts imports heavy modules (hooks, ipc/*, etc.) at top
...
describe('DorkaRuntimeService.fetchRemoteWithCache', () => {
