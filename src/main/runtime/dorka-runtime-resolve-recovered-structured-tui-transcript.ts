...
import { DorkaRuntimeWithStopStructuredSessionProcess } from './dorka-runtime-stop-structured-session-process'
...
export class DorkaRuntimeWithResolveRecoveredStructuredTuiTranscript extends DorkaRuntimeWithStopStructuredSessionProcess {
