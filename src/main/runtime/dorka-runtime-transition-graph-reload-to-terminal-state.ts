...
import { DorkaRuntimeWithHasTerminalsForWorktree } from './dorka-runtime-has-terminals-for-worktree'
...
export class DorkaRuntimeWithTransitionGraphReloadToTerminalState extends DorkaRuntimeWithHasTerminalsForWorktree {
