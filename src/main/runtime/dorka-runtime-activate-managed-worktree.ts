...
import { DorkaRuntimeWithListManagedWorktrees } from './dorka-runtime-list-managed-worktrees'
...
export class DorkaRuntimeWithActivateManagedWorktree extends DorkaRuntimeWithListManagedWorktrees {
  async activateManagedWorktree(
     ...
     *  renderer holds the sleeping records (headless `dorka serve`), so nothing
