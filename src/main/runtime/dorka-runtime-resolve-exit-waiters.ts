...
import { DorkaRuntimeWithBindPtyIncarnationHandle } from './dorka-runtime-bind-pty-incarnation-handle'
...
import { TUI_IDLE_QUIESCENCE_MS } from './dorka-runtime-postlude'

export class DorkaRuntimeWithResolveExitWaiters extends DorkaRuntimeWithBindPtyIncarnationHandle {
