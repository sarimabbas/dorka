...
const { mergeGitLabMRMock, muxRequestMock, parseDorkaYaml, prepareLocalWorktreeRootForRepoMock } =
  mocks
...
function resetRuntimeTestMocks(): void {
  ...
  vi.mocked(parseDorkaYaml).mockReset()
  ...
  vi.mocked(parseDorkaYaml).mockReturnValue(null)
