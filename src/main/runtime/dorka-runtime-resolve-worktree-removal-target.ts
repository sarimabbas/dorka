...
import { DorkaRuntimeWithRemoveManagedWorktree } from './dorka-runtime-remove-managed-worktree'
...
export class DorkaRuntimeWithResolveWorktreeRemovalTarget extends DorkaRuntimeWithRemoveManagedWorktree {
