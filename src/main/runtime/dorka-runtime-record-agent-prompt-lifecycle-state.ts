...
import { DorkaRuntimeWithCreateTerminalSideEffectCommandCodeDetector } from './dorka-runtime-create-terminal-side-effect-command-code-detector'
import type { AgentStatus } from '../../shared/agent-detection'
import { findLastCompleteOscTitleRange } from './dorka-runtime-core'
...
export class DorkaRuntimeWithRecordAgentPromptLifecycleState extends DorkaRuntimeWithCreateTerminalSideEffectCommandCodeDetector {
