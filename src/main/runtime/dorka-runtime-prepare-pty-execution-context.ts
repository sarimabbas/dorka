...
import { DorkaRuntimeWithRegisterPty } from './dorka-runtime-register-pty'
...
export class DorkaRuntimeWithPreparePtyExecutionContext extends DorkaRuntimeWithRegisterPty {
