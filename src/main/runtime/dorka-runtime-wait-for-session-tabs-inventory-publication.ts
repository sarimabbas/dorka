...
import { DorkaRuntimeWithCollectMobileVisibleGraphChangedWorktrees } from './dorka-runtime-collect-mobile-visible-graph-changed-worktrees'

export class DorkaRuntimeWithWaitForSessionTabsInventoryPublication extends DorkaRuntimeWithCollectMobileVisibleGraphChangedWorktrees {
