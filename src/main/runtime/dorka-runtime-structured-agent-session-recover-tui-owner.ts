...
import { DorkaRuntimeWithStructuredAgentSessionReproveTuiOwner } from './dorka-runtime-structured-agent-session-reprove-tui-owner'
...
export class DorkaRuntimeWithStructuredAgentSessionRecoverTuiOwner extends DorkaRuntimeWithStructuredAgentSessionReproveTuiOwner {
