...
import { DorkaRuntimeWithResolveWorktreeRemovalTarget } from './dorka-runtime-resolve-worktree-removal-target'
...
export class DorkaRuntimeWithGetAgentSessionExecutionNamespace extends DorkaRuntimeWithResolveWorktreeRemovalTarget {
