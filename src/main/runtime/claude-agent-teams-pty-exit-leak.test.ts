 ...
 * called solely from `DorkaRuntimeService.closeTerminal` (the explicit user-close IPC).
...
function registerTeam(runtime: DorkaRuntimeService, ptyId: string, leaderHandle: string): void {
