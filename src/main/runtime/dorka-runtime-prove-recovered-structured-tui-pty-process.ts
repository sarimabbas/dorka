...
import { DorkaRuntimeWithGetWorktreePs } from './dorka-runtime-get-worktree-ps'
...
export class DorkaRuntimeWithProveRecoveredStructuredTuiPtyProcess extends DorkaRuntimeWithGetWorktreePs {
