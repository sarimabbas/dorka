...
import { DorkaRuntimeWithHasExactPersistedTerminalSurfaceIdentity } from './dorka-runtime-has-exact-persisted-terminal-surface-identity'
import type {
...
export class DorkaRuntimeWithGetRuntimeId extends DorkaRuntimeWithHasExactPersistedTerminalSurfaceIdentity {
  getRuntimeId(): string {
