...
import { DorkaRuntimeWithCreateTerminal } from './dorka-runtime-create-terminal'
...
import { MOBILE_TERMINAL_CREATE_RESULT_TTL_MS } from './dorka-runtime-core'

export class DorkaRuntimeWithCreateMobileSessionTerminal extends DorkaRuntimeWithCreateTerminal {
