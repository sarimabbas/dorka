...
import { DorkaRuntimeWithVisibleSnapshotPreview } from './dorka-runtime-visible-snapshot-preview'
...
export class DorkaRuntimeWithSerializeHeadlessTerminalBuffer extends DorkaRuntimeWithVisibleSnapshotPreview {
