...
import { DorkaRuntimeWithMaybeHydrateHeadlessFromRenderer } from './dorka-runtime-maybe-hydrate-headless-from-renderer'
...
export class DorkaRuntimeWithCreatePtyHeadlessTerminalState extends DorkaRuntimeWithMaybeHydrateHeadlessFromRenderer {
