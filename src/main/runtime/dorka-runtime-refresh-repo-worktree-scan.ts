...
import { DorkaRuntimeWithListKnownResolvedWorktreesForExplicitTarget } from './dorka-runtime-list-known-resolved-worktrees-for-explicit-target'
import type { Repo } from '../../shared/repo-types'
import type { ProjectExecutionRuntimeResolution } from '../../shared/project-execution-runtime'
import type { RuntimeWorktreeScanCache, RuntimeWorktreeScanRefresh } from './dorka-runtime-core'
...
export class DorkaRuntimeWithRefreshRepoWorktreeScan extends DorkaRuntimeWithListKnownResolvedWorktreesForExplicitTarget {
  /**
