...
import { DorkaRuntimeWithTransitionGraphReloadToTerminalState } from './dorka-runtime-transition-graph-reload-to-terminal-state'
...
import type { ResolvedTerminalWorkspaceLaunchTarget } from './dorka-runtime-core'
import { AGENT_HOOK_RUNTIME_ENV_KEYS } from './dorka-runtime-core'
...
export class DorkaRuntimeWithResolveBrowserNetworkExecutionHostForWorktree extends DorkaRuntimeWithTransitionGraphReloadToTerminalState {
  ...
  protected buildTerminalWorkspaceEnv(
    ...
    return {
      ...env,
      DORKA_WORKSPACE_ID: scope.id,
      DORKA_PROJECT_GROUP_ID: scope.folderWorkspace.projectGroupId,
      DORKA_WORKSPACE_ROOT: scope.folderWorkspace.folderPath
    }
  }
