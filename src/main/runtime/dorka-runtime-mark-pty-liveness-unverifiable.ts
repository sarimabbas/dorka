...
import { DorkaRuntimeWithOnPtyExit } from './dorka-runtime-on-pty-exit'
...
export class DorkaRuntimeWithMarkPtyLivenessUnverifiable extends DorkaRuntimeWithOnPtyExit {
  /**
  ...
  /**
   * Records that Dorka asked this PTY to stop — a close, a stop, a teardown.
   *
