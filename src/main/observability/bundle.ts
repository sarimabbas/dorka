...
// user-initiated network path from the error-tracking lane to Dorka infra. The per-bundle
...
export type CollectBundleOptions = {
  ...
  readonly dorkaChannel: 'stable' | 'rc' | 'dev'
}
...
type BundleHeader = {
  ...
  readonly dorka_channel: 'stable' | 'rc' | 'dev'
...
export function collectBundle(opts: CollectBundleOptions): CollectedBundle {
  ...
  const header: BundleHeader = {
    ...
    dorka_channel: opts.dorkaChannel,
