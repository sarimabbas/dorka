...
export function getStatusPluginFactorySource(options: {
  ...
  return [
    ...
    'export const DorkaOpenCodeStatusPlugin = async (_ctx) => {',
    `  if (process.env.DORKA_OPENCODE_AGENT && process.env.DORKA_OPENCODE_AGENT !== '${expectedAgent}') return {};`,
    ...
    ...(options.emitNextEvents
      ? [
          ...
          '    // bounded Dorka lifecycle and preview posts.',
    ...
    '          // publish a final idle so Dorka does not retain a dead owner.',
    ...
    'export default {',
    '  id: "dorka-opencode-status",',
    '  server: DorkaOpenCodeStatusPlugin,',
