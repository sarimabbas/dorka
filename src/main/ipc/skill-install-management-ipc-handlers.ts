...
async function previewBundleInstall(runtime: DorkaRuntimeService, input: BundlePreviewInput) {
...
export function registerSkillInstallManagementIpcHandlers(runtime: DorkaRuntimeService): void {
