...
describe('Dorka automation traffic priority', () => {
  it('parks queued probes while Dorka automation work holds the installed lease', async () => {
    // Dorka CRUD and dispatch arrive through the runtime methods, which take the
