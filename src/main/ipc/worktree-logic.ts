...
import type { GlobalSettings, DorkaWorkspaceLayout } from '../../shared/global-settings-types'
 ...
 * Windows workspace layout inside ~/dorka/workspaces on the WSL filesystem
 * (e.g. \\wsl.localhost\Ubuntu\home\user\dorka\workspaces\repo\feature).
 */
...
function workspaceRootForMirrorHome(
  ...
  return wslHome
    ? win32.join(wslHome, 'dorka', 'workspaces')
