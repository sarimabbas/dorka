...
export function createWorktreePollerWindowVisibility(
  ...
  // that has NEVER been shown is either headless (DORKA_E2E_HEADLESS keeps a live but
...
// churn to Dorka just to observe a handful of shallow paths. The replacements
...
// Dorka's own worktree operations notify the renderer directly.
