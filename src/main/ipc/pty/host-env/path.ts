...
export function promoteAgentTeamsShimPath(
  ...
  if (!env?.DORKA_AGENT_TEAMS_TEAM_ID) {
    return
  }
  ...
  // Why: host env injection prepends Dorka's shims; Claude Agent Teams must still resolve our fake tmux before any real tmux.
