...
describe('DroidHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'dorka-droid-home-'))
    userDataDir = mkdtempSync(join(tmpdir(), 'dorka-droid-user-data-'))
  ...
  it.skipIf(process.platform !== 'win32')(
    ...
    () => {
      const spaceHome = join(tmpdir(), 'dorka droid home with spaces')
