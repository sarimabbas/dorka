...
export function buildSshPtySpawnEnv(args: {
  ...
  if (args.remoteCliBridgeEnv) {
    ...
    merged.DORKA_REMOTE_CLI_BIN_DIR = args.remoteCliBridgeEnv.binDir
    merged.DORKA_RELAY_DIR = args.remoteCliBridgeEnv.relayDir
    merged.DORKA_RELAY_NODE_PATH = args.remoteCliBridgeEnv.nodePath
    merged.DORKA_RELAY_SOCKET_PATH = args.remoteCliBridgeEnv.sockPath
    if (args.remoteCliBridgeEnv.credentialFile) {
      merged.DORKA_RELAY_CREDENTIAL_FILE = args.remoteCliBridgeEnv.credentialFile
    }
  }
