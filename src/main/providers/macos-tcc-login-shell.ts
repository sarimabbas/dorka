...
const LOGIN_PREFLIGHT_MARKER = 'DORKA_LOGIN_PREFLIGHT_OK'
 ...
 */
const DISABLE_ENV_VAR = 'DORKA_DISABLE_MACOS_LOGIN_SHELL'
 ...
 * get their own TCC identity instead of collapsing into Dorka's bundle id — signed
 * CLIs like `op` otherwise re-prompt every launch because tccd attributes the grant
 * to Dorka and never persists it (#6996, #8985).
 *
...
export function wrapShellSpawnForMacosTccAttribution(
  ...
  // Why: Bash ignores --rcfile when argv[0] marks it as a login shell; Dorka's
