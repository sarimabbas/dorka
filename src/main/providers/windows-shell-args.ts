...
export const DORKA_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV = 'DORKA_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE'
const CMD_CODEX_LAUNCH_PREFLIGHT = `if defined DORKA_CODEX_LAUNCH_PREFLIGHT call %${DORKA_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}%%DORKA_CODEX_LAUNCH_PREFLIGHT%%${DORKA_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}% agent hooks prepare-codex > nul 2>&1`
...
function buildWslShellArgs(linuxCwd: string, distro?: string): string[] {
  ...
  // login shell so terminal PATH matches the environment Dorka detects.
