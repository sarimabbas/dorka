...
export type PtySpawnOptions = {
  ...
  /** Dorka worktree identity. When present, the local provider scopes shell
  ...
  /** Managed Computer generation the relay must atomically verify before physical spawn. */
