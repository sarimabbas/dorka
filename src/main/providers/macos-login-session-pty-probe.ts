...
const LOGIN_PROBE_USERNAME_ENV = 'DORKA_LOGIN_PROBE_USERNAME'
// Why: expect owns the PTY without adding a long-lived native handle to the daemon.
const EXPECT_LOGIN_PROBE_SCRIPT =
  'log_user 1; ' +
  'spawn -noecho /usr/bin/login -flpq $env(DORKA_LOGIN_PROBE_USERNAME) /usr/bin/printf DORKA_LOGIN_PREFLIGHT_OK; ' +
