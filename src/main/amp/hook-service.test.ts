...
describe('AmpHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'dorka-amp-home-'))
  ...
  it('installs an Dorka-managed Amp system plugin', () => {
    ...
    expect(source).toContain('process.env.DORKA_PANE_KEY')
  ...
  it('removes only Dorka-managed Amp plugin files', () => {
