...
export function resolveAutomationRunTarget(
  ...
  if (
    ...
    return {
      ok: false,
      error:
        'Remote-server automation scheduling is not available from this Dorka client yet. Run this automation on the remote server or update Dorka when durable remote scheduling is available.'
    }
  }
