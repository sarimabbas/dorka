...
export const NO_DISPATCH_HOST = 'No Dorka window was available to launch the automation.'
...
export function recordMissedRun(input: {
  ...
  input.runs.updateRun({
    ...
    workspaceId: input.automation.workspaceId,
    error: 'This run was past its missed-run grace window when Dorka next checked.'
  })
}
