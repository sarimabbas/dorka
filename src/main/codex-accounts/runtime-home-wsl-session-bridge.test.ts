...
describe('CodexRuntimeHomeService', () => {
  ...
  it('keeps WSL in-Codex setting changes in the direct system home', async () => {
    ...
    try {
      ...
      const baselinePath = join(wslRuntimeHomePath, '.dorka-config-settings-baseline.json')
      ...
      return {
        ...
        parseWslUncPath: (candidate: string) =>
          candidate.includes('codex-accounts/debian-account/home')
            ? {
                distro: 'Debian',
                linuxPath: '/home/alice/.local/share/dorka/codex-accounts/debian-account/home'
              }
            : null
      }
    })
        ...
        codexManagedAccounts: [
          {
            ...
            wslDistro: 'Debian',
            wslLinuxHomePath: '/home/alice/.local/share/dorka/codex-accounts/debian/home',
  ...
  it('does not rescan retired sessions after the launch drain bridges them', async () => {
    ...
    const managedHomePath = join(wslHome, '.local', 'share', 'dorka', 'codex-accounts', 'a', 'home')
  ...
  it.skipIf(process.platform === 'win32')(
    ...
    async () => {
      ...
      const retiredHome = join(guestHome, '.local', 'share', 'dorka', 'codex-runtime-home', 'home')
