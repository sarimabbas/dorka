...
import { getDorkaManagedCodexHomePath, getDorkaUserDataPath } from '../codex/codex-home-paths'
...
export abstract class CodexRuntimeHomePaths extends CodexRuntimeHomeState {
  protected getRuntimeHomePath(): string {
    return getDorkaManagedCodexHomePath()
  }
  ...
  getMirroredHostHomePathForStatus(): CodexMirroredHomeStatus {
    ...
    return {
      kind: 'ready',
      homePath: join(getDorkaUserDataPath(), 'codex-runtime-home', 'home')
    }
  }
