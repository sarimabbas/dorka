...
import type { ensureActiveDorkaProfile } from '../dorka-profiles/profile-index-store'
...
export const mainProcessState = {
  ...
  runtime: null as DorkaRuntimeService | null,
  rateLimits: null as RateLimitService | null,
  runtimeRpc: null as DorkaRuntimeRpcServer | null,
  ...
  activeDorkaProfile: null as ReturnType<typeof ensureActiveDorkaProfile> | null,
