...
//
declare const DORKA_BUILD_IDENTITY: 'stable' | 'rc' | null
declare const DORKA_POSTHOG_WRITE_KEY: string | null
...
// `DORKA_DIAGNOSTICS_TOKEN_URL` env var, which env wins so a developer can
// point a packaged build at a staging server without re-running the
// release pipeline.
declare const DORKA_DIAGNOSTICS_TOKEN_URL: string | null
