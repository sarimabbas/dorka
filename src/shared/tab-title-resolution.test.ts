...
describe('tab title resolution', () => {
  ...
  it('keeps OpenCode native and Dorka-generated title behavior intact', () => {
    const aiVaultTitle = {
      ...
      resolveTerminalTabTitle(
        {
          customTitle: null,
          aiVaultTitle,
          generatedTitle: 'Dorka generated',
    ...
    expect(
      resolveTerminalTabTitle(
        { customTitle: null, generatedTitle: 'Dorka generated', title: '⠋ albacore' },
        true
      )
    ).toBe('Dorka generated')
  })
