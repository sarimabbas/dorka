...
const REQUEST_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    ...
    message: 'Timed out waiting for the remote Dorka runtime to respond.'
  },
  {
  ...
  },
  {
    ...
    message: 'Could not connect to the remote Dorka runtime.'
  },
  producedPair(
  ...
  },
  {
    ...
    code: 'remote_runtime_unavailable',
    message: `Remote Dorka runtime closed the connection (1011: ${CLOSE_REASON.toString()}).`
  },
  {
    producer: 'remote-runtime-client.ts:289',
    code: 'invalid_runtime_response',
    message: 'Remote Dorka runtime returned an unexpected binary frame.'
  },
  {
    producer: 'remote-runtime-client.ts:310 / :693',
    code: 'invalid_runtime_response',
    message: 'Remote Dorka runtime returned an undecryptable frame.'
  },
  {
    producer: 'remote-runtime-client.ts:393 / :801 (rejected token)',
    code: 'unauthorized',
    message: 'Remote Dorka runtime rejected the pairing token.'
  },
  {
    producer: 'remote-runtime-client.ts:393 / :801 (unparseable auth failure)',
    code: 'invalid_runtime_response',
    message: 'Remote Dorka runtime returned an invalid E2EE auth frame.'
  },
  {
    producer: 'remote-runtime-client.ts:415',
    code: 'remote_runtime_unavailable',
    message: 'Remote Dorka runtime request was released before it could be sent.'
  },
  {
    producer: 'remote-runtime-client.ts:459 / :829',
    code: 'invalid_runtime_response',
    message: 'Remote Dorka runtime returned a mismatched response id.'
  },
  {
  ...
  },
  {
    ...
    code: 'runtime_timeout',
    message: 'Timed out waiting for the remote Dorka runtime subscription to start.'
  },
  {
    producer: 'remote-runtime-client.ts:587',
    code: 'remote_runtime_unavailable',
    message: 'Remote Dorka runtime send buffer overflow; reconnecting.'
  },
  {
    producer: 'remote-runtime-client.ts:735',
    code: 'remote_runtime_unavailable',
    message: 'Remote Dorka runtime stopped responding; the stream connection was reset.'
  },
  {
    producer: 'remote-runtime-client.ts:842',
    code: 'invalid_runtime_response',
    message: 'Remote Dorka runtime returned binary data before authentication.'
  },
  {
    producer: 'remote-runtime-client.ts:852',
    code: 'invalid_runtime_response',
    message: 'Remote Dorka runtime returned an undecryptable binary frame.'
  },
  {
  ...
  producedPair(
    ...
    invalidRemoteRuntimeResponseError('Remote Dorka runtime returned an invalid E2EE auth frame.')
  ),
  producedPair(
...
const SHARED_CONTROL_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  producedPair(
    ...
    remoteRuntimeUnavailableError(
      'Remote Dorka runtime stopped responding; resetting the control connection.'
    )
  ),
  producedPair(
...
const HOST_FORWARDED_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
    code: 'invalid_runtime_response',
    message: 'Remote Dorka runtime returned an invalid response frame.'
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
...
const CODELESS_TRANSPORT_ERRORS: (TransportErrorPair & { recoverable: boolean })[] = [
  {
    ...
    message: 'Remote Dorka runtime is not connected.',
    recoverable: true
  },
  {
    producer: 'web-runtime-client.ts:359 / :360 / :591',
    message: 'Remote Dorka runtime connection closed.',
    recoverable: true
  },
  {
