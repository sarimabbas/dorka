...
// Why device-wide wording: the gate has no caller identity, so `dorka artifacts share` typed by a
...
export const ARTIFACT_SHARING_DISABLED_MESSAGE =
  'Publishing artifacts is off for this device. Nothing running here — agents or the dorka CLI — can mint public artifact links until you allow it.'

export const ARTIFACT_SHARING_DISABLED_NEXT_STEPS: readonly string[] = [
  'Open Settings → Artifacts in the Dorka desktop app on this device.',
