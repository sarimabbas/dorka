...
export const WSL_BROWSER_NETWORK_RELAY_DIR = '.dorka-wsl/browser-network'
export const WSL_BROWSER_NETWORK_RELAY_SENTINEL = 'DORKA-WSL-BROWSER-NETWORK v1 READY\n'
export const WSL_BROWSER_NETWORK_RELAY_STALE_EXIT_CODE = 72
export const WSL_BROWSER_NETWORK_RELAY_NO_NODE_EXIT_CODE = 73
