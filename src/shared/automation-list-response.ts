...
const UNSUPPORTED_HOST_SCOPE_MESSAGE =
  'This host does not support per-host automation lists. Update the Dorka server to filter by host.'
const INVALID_RESPONSE_MESSAGE = 'This host returned an automation list Dorka could not read.'
