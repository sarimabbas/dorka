...
// discipline sits between Dorka and the querying program can echo it straight back out as
...
//
// The reply is written IMMEDIATELY, in the caller's turn. Dorka used to withhold it until
