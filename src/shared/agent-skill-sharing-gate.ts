...
export const AGENT_SKILL_SHARING_DISABLED_MESSAGE =
  'Publishing skill links from agents and the Dorka CLI is off for this device.'

export const AGENT_SKILL_SHARING_DISABLED_NEXT_STEPS: readonly string[] = [
  'Open Settings → Share Skills in the Dorka desktop app on this device.',
  'Turn on "Allow agents and the Dorka CLI to publish skill links".',
