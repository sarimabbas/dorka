...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote dorka runtime|remote dorka runtime closed the connection|timed out (?:waiting for|while connecting to) the remote dorka runtime/i
