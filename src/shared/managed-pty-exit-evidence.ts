...
export function isManagedExecutionUuid(value: unknown): value is string {
  return (
    typeof value === 'string' &&
...
export function isManagedPtyExitRecord(value: unknown): value is Record<string, unknown> {
  return typeof value === 'object' && value !== null && !Array.isArray(value)
}

function isRecord(value: unknown): value is Record<string, unknown> {
  return isManagedPtyExitRecord(value)
}
