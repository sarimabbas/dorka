...
export const DORKA_SKILLS_REPOSITORY_URL = 'https://github.com/stablyai/orca'

export const DORKA_CLI_SKILL_NAME = 'dorka-cli'
...
export const DORKA_CLI_SKILL_INSTALL_COMMAND = buildAgentFeatureSkillInstallCommand([
  DORKA_CLI_SKILL_NAME
])

export const DORKA_CLI_SKILL_UPDATE_COMMAND =
  buildAgentFeatureSkillUpdateCommand(DORKA_CLI_SKILL_NAME)
...
export const DORKA_CLI_ORCHESTRATION_SKILL_INSTALL_COMMAND = buildAgentFeatureSkillInstallCommand([
  DORKA_CLI_SKILL_NAME,
  ORCHESTRATION_SKILL_NAME
])

export const DORKA_LINEAR_SKILL_INSTALL_COMMAND = buildAgentFeatureSkillInstallCommand([
  DORKA_LINEAR_SKILL_NAME
])

export const DORKA_LINEAR_SKILL_UPDATE_COMMAND =
  buildAgentFeatureSkillUpdateCommand(DORKA_LINEAR_SKILL_NAME)
