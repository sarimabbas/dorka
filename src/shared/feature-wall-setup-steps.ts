...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use Dorka's browser",
    subtitle: "Use Dorka's browser",
    description:
      'Browse your web app without leaving Dorka. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable Dorka CLI',
    subtitle: 'Enable Dorka CLI',
    description:
      'Register the Dorka shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into Dorka so you can start agent work without hunting for folders.'
  }
] as const
