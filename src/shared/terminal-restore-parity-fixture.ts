...
import { activateDorkaTerminalUnicodeProvider } from './terminal-unicode-provider'
 ...
 *  (pane-dom-creation.ts) and the Dorka ZWJ provider (pane-lifecycle.ts).
 ...
 *    while Dorka's WebGL glyph renderer skips decorations on null cells.
 ...
 *  DorkaRuntime.serializeHeadlessTerminalBuffer (normal buffer separated from
