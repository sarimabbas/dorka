...
// Why: declares the Dorka runtime RPC compatibility contract. Desktop,
...
export const JIRA_USER_FIELDS_UPDATE_REQUIRED_MESSAGE =
  'Creating Jira issues with user fields requires a newer Dorka server. Update the server and try again.'
...
// the hook was found — an SSH host whose dorka.yaml cannot be read answers "no hook" and the removal
...
export const AGENT_REFERENCES_RUNTIME_CAPABILITY = 'agents.references.v1' as const
export const AGENT_RUN_HISTORY_RUNTIME_CAPABILITY = 'agents.run-history.v1' as const
...
export const FILE_MUTATION_OWNERSHIP_UPDATE_REQUIRED_MESSAGE =
  'Remote file changes require a newer Dorka server. Update the HUB and try again.'
...
export const GITHUB_MARK_PR_READY_UPDATE_REQUIRED_MESSAGE =
  'Marking a pull request ready requires a newer Dorka server. Update the server and try again.'
...
export const GITLAB_READY_FOR_REVIEW_UPDATE_REQUIRED_MESSAGE =
  'Marking a merge request ready requires a newer Dorka server. Update the server and try again.'
...
export const AUTOMATION_LIST_HOST_SCOPE_UPDATE_REQUIRED_MESSAGE =
  'Filtering automations by host requires a newer Dorka server. Update the HUB and try again.'
...
export const AUTOMATION_OWNER_FENCING_UPDATE_REQUIRED_MESSAGE =
  'Editing automations on this host requires a newer Dorka server. Update the HUB and try again.'
