...
export const HOURLY_RELEASE_REPO = 'stablyai/dorka-hourly'
export const DAILY_RELEASE_REPO = 'stablyai/dorka-daily'
export const ADHOC_RELEASE_REPO = 'stablyai/dorka-adhoc'
