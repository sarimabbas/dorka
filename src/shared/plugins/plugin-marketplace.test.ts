...
describe('marketplace provenance contracts', () => {
  it.each([
    ['stablyai.dorka-skills', true, true],
    ['stablyai.skills', true, false],
    ['community.dorka-skills', true, false],
  ...
  it.each([
    'https://github.com/stablyai/dorka-skills.git',
    'ssh://git@github.com/stablyai/dorka-skills.git',
    'git@github.com:stablyai/dorka-skills.git'
  ...
  it('does not trust lookalike organizations or hosts', () => {
    expect(isOfficialOrganizationGitSource('https://github.com/stablyai-fakes/dorka-skills')).toBe(
      false
    )
    expect(isOfficialOrganizationGitSource('https://gitlab.com/stablyai/dorka-skills')).toBe(false)
  })
