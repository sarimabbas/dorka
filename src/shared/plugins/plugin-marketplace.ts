...
export const PLUGIN_MARKETPLACE_FILENAME = 'dorka-marketplace.json'
...
export const OFFICIAL_PLUGIN_ID_PREFIX = 'dorka-'
export const OFFICIAL_MARKETPLACE_OWNER = 'stablyai'
export const OFFICIAL_MARKETPLACE_REPOSITORY = 'dorka-plugins'
