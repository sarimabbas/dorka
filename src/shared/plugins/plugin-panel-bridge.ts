...
export const PANEL_ACTION_REQUEST_TYPE = 'dorka-panel-action'
export const PANEL_ACTION_RESULT_TYPE = 'dorka-panel-action-result'
export const PANEL_PING_TYPE = 'dorka-panel-ping'
export const PANEL_PONG_TYPE = 'dorka-panel-pong'
export const PLUGIN_PANEL_FRAME_NAME_PREFIX = 'dorka-plugin-panel:'
