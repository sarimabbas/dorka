...
export function createMobileRelayPairingFixtures(now: number): PairingFixture[] {
  ...
  return [
    ...
    },
    {
      ...
      payload: { ...directOffer, relay: { ...relay, directorUrl: 'https://relay.ondorka.dev/' } },
      expected: null
    },
    {
      name: 'non-HTTPS cell origin is invalid',
      payload: { ...directOffer, relay: { ...relay, cellUrl: 'http://relay-c1.ondorka.dev' } },
      expected: null
    },
    {
