...
// Why: a headed Dorka server keeps answering status.get after its workspace window
...
// window exists (dorka-runtime.ts:4806), so pairing it with a non-ready graph is the
