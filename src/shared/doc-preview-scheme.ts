 ...
 * `dorka-preview://<grantId>/<relative-path>` by reading the owning workspace's
 ...
 */
export const DOC_PREVIEW_SCHEME = 'dorka-preview'
...
export const DOC_PREVIEW_PARTITION = 'dorka-doc-preview'
 ...
 * offers, and the notice this becomes is Dorka's chrome — a payload with a path invites rendering
