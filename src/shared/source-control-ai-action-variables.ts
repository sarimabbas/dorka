...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'Dorka’s built-in prompt for this action, including the context Dorka knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the Dorka workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when Dorka has one available.',
