...
describe('skills CLI agent keys', () => {
  ...
  it('covers every agent Dorka can detect', () => {
  ...
  it("follows Dorka's own evidence for the two non-obvious mappings", () => {
    ...
    // Why: Dorka detects trae via `traecli`, which tui-agent-config calls an alias
