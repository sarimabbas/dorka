...
export const ORCHESTRATION_COMPATIBILITY_HOST_KIND_ENV =
  'DORKA_ORCHESTRATION_COMPATIBILITY_HOST_KIND'
export const ORCHESTRATION_COMPATIBILITY_HOST_ID_ENV = 'DORKA_ORCHESTRATION_COMPATIBILITY_HOST_ID'
export const ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION_ENV =
  'DORKA_ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION'
export const ORCHESTRATION_COMPATIBILITY_ATTACHMENT_ENV =
  'DORKA_ORCHESTRATION_COMPATIBILITY_ATTACHMENT'
...
export function readOrchestrationCompatibilityEvidence(
  ...
  const terminalHandle = boundedValue(env.DORKA_TERMINAL_HANDLE)
  const paneKey = boundedValue(env.DORKA_PANE_KEY)
  const launchToken = boundedValue(env.DORKA_AGENT_LAUNCH_TOKEN)
