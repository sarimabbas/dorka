...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__dorka_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__dorkaBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-dorka-browser-annotation-overlay';
  const markerSize = 24;
