...
describe('parseAgentStatusPayload', () => {
  ...
  it('compacts Dorka dispatch preambles so the task body survives 200-char truncation', () => {
...
Fix dispatch fallback preview for normalized status prompts`
    ...
    expect(result!.prompt.startsWith('You are working inside Dorka, a multi-agent IDE.')).toBe(true)
