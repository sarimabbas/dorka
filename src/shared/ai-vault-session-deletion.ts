...
// Agents whose sessions Dorka can remove completely: everything the session
...
// why (a provider's storage layout is Dorka's problem, not the reader's):
...
// - codex: session_index.jsonl plus hardlink aliases between the Dorka-managed
