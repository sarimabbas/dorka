...
export type EnvBlockedReason = 'do_not_track' | 'dorka_disabled' | 'ci'
...
export function envVarNameForReason(reason: EnvBlockedReason): string {
  ...
  if (reason === 'dorka_disabled') {
    return 'DORKA_TELEMETRY_DISABLED'
  }
  return 'CI'
}
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Help us figure out what to build next. Dorka sends anonymous counts of which features you use and where things break.'
            )}{' '}
            <button
              type="button"
