          ...
          <p className="text-xs leading-5 text-muted-foreground">
            {notice.kind === 'checking'
              ? translate(
                  ...
                  'Local scripts are saved. Dorka is still checking dorka.yaml before it can recommend which script source to use.'
                )
              : translate(
                  'auto.components.settings.RepositoryHooksSection.0ce113fd7b',
                  'Local scripts are saved, but Script Source is set to dorka.yaml only.'
                )}
          </p>
        </div>
      </div>
