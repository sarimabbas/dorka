...
const DORKA_IOS_APP_STORE_URL = 'https://apps.apple.com/app/dorka-ide/id6766130217'
const DORKA_ANDROID_APK_URL =
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install Dorka Mobile from the'
            )}{' '}
            <button
              type="button"
              onClick={() => void window.api.shell.openUrl(DORKA_IOS_APP_STORE_URL)}
            ...
            <button
              ...
              onClick={() => void window.api.shell.openUrl(DORKA_ANDROID_APK_URL)}
              className="cursor-pointer underline underline-offset-2 hover:text-foreground"
            >
              {translate(
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show Dorka Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the Dorka Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Dorka Mobile shortcut in the sidebar.'
          )}
