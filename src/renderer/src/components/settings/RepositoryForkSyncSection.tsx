  ...
  return {
    ...
    description:
      ...
      translate(
        ...
        'Dorka could not fast-forward this fork safely.'
      )
  }
}
        ...
        <div className="min-w-0 space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'When this fork is behind upstream, Dorka can safely fast-forward its default branch. Dorka skips the update if the branch has local-only commits or conflicts.'
            )}
          </p>
          <p className="text-xs text-muted-foreground">
            {translate(
