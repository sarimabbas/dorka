...
export const getGeneralWorkspaceSearchEntries = createLocalizedCatalog(() => [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose whether worktrees created outside Dorka appear by default.'
    ),
    keywords: [
...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'Dorka CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the Dorka CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the Dorka skill so agents know to use the Dorka CLI.'
    ),
    keywords: [
...
export const getGeneralUpdateSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Check for app updates and install a newer Dorka version.'
    ),
    keywords: [
