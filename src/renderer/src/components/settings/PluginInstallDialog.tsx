        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {translate(
              ...
              'Installing copies the plugin into Dorka and shows its permissions for review. No plugin code runs until you enable it.'
            )}
          </DialogDescription>
        </DialogHeader>
        <form
            ...
            <TabsContent value="local-path" className="space-y-2 pt-2">
              ...
              <p className="text-xs leading-5 text-muted-foreground">
                {translate(
                  ...
                  'Full path to a folder containing dorka-plugin.json on this computer. The path is used exactly as entered.'
                )}
              </p>
            </TabsContent>
            <TabsContent value="git" className="space-y-2 pt-2">
              ...
              <Input
                ...
                placeholder={translate(
                  ...
                  'https://git.example/acme/dorka-notes#v0.1.0'
                )}
                spellCheck={false}
