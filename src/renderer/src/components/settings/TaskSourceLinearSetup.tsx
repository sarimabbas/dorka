      ...
      <ol className="divide-y divide-border/50">
        <TaskSourceStepRow
          ...
          description={translate(
            ...
            'Add a Personal API key so Dorka can browse issues and open workspaces with ticket context.'
          )}
          action={
            <Button
              type="button"
        ...
        <TaskSourceStepRow
          ...
          description={translate(
            ...
            'Gives agents /dorka-linear to read tickets, post updates, move states, and attach pull or merge requests.'
          )}
