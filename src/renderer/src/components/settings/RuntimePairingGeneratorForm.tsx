              ...
              [
                ...
                [
                  ...
                  translate(
                    ...
                    'A browser or Dorka client on this computer'
                  )
                ],
                [
                  'custom',
          ...
          <div className="rounded-md border border-border/60 bg-muted/30 p-3 text-xs">
            ...
            <p className="mt-1 text-muted-foreground">
              {translate(
                ...
                'This link only works in a browser or Dorka client running on this computer.'
              )}
            </p>
      ...
      {generatedIsCurrent && webClientUrl ? (
        ...
        <UnavailableUrlRow
          ...
          description={translate(
            ...
            'Browser link unavailable in this build. The pairing URL still works for Dorka clients.'
          )}
        />
      ) : null}
      ...
      {generatedIsCurrent && runtimePairingUrl ? (
        <GeneratedUrlRow
          label={translate(
            ...
            'Pair another Dorka client'
          )}
          description={translate(
            'auto.components.settings.RuntimePairingUrlGenerator.849825e829',
            'Paste this pairing URL into another Dorka client.'
          )}
