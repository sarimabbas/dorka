...
const updateCapableCallers = new Map<string, readonly string[]>([
  ...
  [
    ...
    ['DORKA_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={cliSkillUpdateCommand}']
  ],
  [
    'src/renderer/src/components/settings/BrowserUsePane.tsx',
    ['DORKA_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={browserUseUpdateCommand}']
  ],
  [
  ...
  [
    ...
    ['DORKA_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={updateCommand}']
  ],
  [
  ...
  [
    ...
    [
      ...
      'buildSkillCommandForRuntime(DORKA_CLI_SKILL_INSTALL_COMMAND)',
      'buildSkillCommandForRuntime(DORKA_CLI_SKILL_UPDATE_COMMAND)'
    ]
  ]
])
...
describe('AgentSkillSetupPanel installed-command call sites', () => {
  ...
  it('routes the combined feature-tip install through runtime command setup', () => {
    ...
    expect(source).not.toContain('command={DORKA_CLI_ORCHESTRATION_SKILL_INSTALL_COMMAND}')
