...
const AUTOMATIC_DEVICE_VALUE = '__dorka_automatic_emulator_device__'
  ...
  const defaultDeviceDescription = useMemo(() => {
    if (devices.length === 0) {
      return translate(
        ...
        'Dorka will auto-select an emulator device after devices are detected.'
      )
    }
    return translate(
    ...
    <div className="space-y-4">
      <SearchableSetting
        ...
        description={translate(
          ...
          'Configure mobile emulator support for Dorka and coding agents.'
        )}
