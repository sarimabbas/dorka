        ...
        <AppearanceAdvancedDisclosure showTopBorder={false}>
          <div className="divide-y divide-border/40">
            <SearchableSetting
              ...
              keywords={titlebarEntry?.keywords ?? ['titlebar', 'dorka', 'app', 'name']}
            >
              <SettingsSwitchRow
                label={translate(
                  'auto.components.settings.AppearancePane.9868f39007',
            ...
            {isDesktopWindows ? (
              ...
              >
                <SettingsSwitchRow
                  ...
                  // Why: platform constraint + "close keeps Dorka running" consequence are
                  // both non-obvious from the label alone.
                  description={translate(
                    'auto.components.settings.AppearancePane.b707773a0d',
                    'When enabled, closing the window keeps Dorka running in the system tray instead of quitting.'
                  )}
              ...
              >
                <SettingsSwitchRow
                  ...
                  description={translate(
                    ...
                    'Keep an Dorka shortcut and activity indicator in the macOS menu bar.'
                  )}
