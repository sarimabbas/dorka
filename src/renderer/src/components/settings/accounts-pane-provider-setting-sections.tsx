    ...
    <section key="gemini" id="accounts-gemini" className="space-y-4 scroll-mt-6">
      ...
      <SearchableSetting
        ...
        description={translate(
          ...
          'Extracts OAuth credentials from your local Gemini CLI installation to authenticate with Google. This uses credentials issued to the Gemini CLI app, not Dorka. May break if Google updates the CLI. Use at your own risk.'
        )}
        keywords={[
          'gemini',
          'cli',
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Extracts OAuth credentials from your local Gemini CLI installation to authenticate with Google for {{value0}}. This uses credentials issued to the Gemini CLI app, not Dorka. May break if Google updates the CLI. Use at your own risk.',
