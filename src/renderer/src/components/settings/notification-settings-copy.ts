...
export function getSystemNotificationSettingsCopy(
  ...
  if (platform === 'darwin') {
    return {
      ...
      failureDescription: 'Enable Allow notifications for Dorka in System Settings.'
    }
  }
  ...
  if (platform === 'win32') {
    return {
      ...
      failureDescription: 'Enable notifications for Dorka in Windows Settings.'
    }
  }
      ...
      toast.message(
        ...
        ),
        {
          description: translate(
            ...
            'If no macOS banner appeared, enable Allow notifications for Dorka.'
          ),
          action: {
            label: translate(
      ...
      toast.error(
        ...
        ),
        {
          description: translate(
            ...
            'Check your desktop notification settings for Dorka.'
          )
        }
      )
    }
