...
import { DORKA_LINEAR_SKILL_NAME } from '@/lib/agent-feature-install-commands'
  ...
  return (
    <SearchableSetting
      ...
      description={translate(
        ...
        'How Linear works in Dorka: browse issues, start linked workspaces, and let agents update tickets with /dorka-linear.'
      )}
    ...
    >
      ...
      <SkillUsageExamplesSection
        ...
        slashCommand={`/${DORKA_LINEAR_SKILL_NAME}`}
      />
