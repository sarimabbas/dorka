...
const AGENT_CAPABILITY_SETUP_ROWS: readonly AgentCapabilitySetupRow[] = [
  {
    ...
    get description() {
      return translate(
        ...
        'Let agents coordinate through Dorka to keep large, multi-step tasks moving to completion.'
      )
    },
  ...
  },
  {
    ...
    get description() {
      return translate(
        ...
        "Give agents direct access to Dorka's browser so they can test pages, capture screenshots, and act on what they see."
      )
    },
