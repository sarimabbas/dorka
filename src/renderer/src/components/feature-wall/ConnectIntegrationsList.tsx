      ...
      <div className="space-y-2.5">
        <IntegrationStep
          ...
          description={translate(
            ...
            'Connect a review provider so Dorka can show PR or MR status, checks, and reviews.'
          )}
          summary={
            <>
        ...
        <IntegrationStep
          ...
          title={translate(
            ...
            'Start agents on your tasks without leaving Dorka'
          )}
          description={translate(
            'auto.components.feature.wall.ConnectIntegrationsList.33b650af52',
            'Connect where your team tracks work. Dorka starts workspaces with the issue title, link, and context already attached.'
          )}
          summary={
