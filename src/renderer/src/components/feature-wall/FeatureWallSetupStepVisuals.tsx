...
// Mac-style terminal traffic-light dots — the signature of an Dorka terminal pane.
...
// Use Dorka's browser: a browser pane with a cursor grabbing one highlighted
