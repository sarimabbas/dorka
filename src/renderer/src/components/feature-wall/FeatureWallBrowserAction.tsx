...
// needs the Dorka CLI and browser skill, not Computer Use or orchestration.
...
// The grab→agent flow relies on the Dorka CLI and browser skill, so offer the same
// install action the Enable Dorka CLI step uses, scoped to just browser use.
