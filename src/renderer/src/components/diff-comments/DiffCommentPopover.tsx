...
export function DiffCommentPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="dorka-diff-comment-popover"
    ...
    >
      {/* Content */}
      <div className="dorka-diff-comment-content-col" style={{ gap: '8px' }}>
        <div id={labelId} className="dorka-diff-comment-popover-label">
          {title ??
