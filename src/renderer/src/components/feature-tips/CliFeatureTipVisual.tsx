...
const CLI_AGENT_COMMANDS = [
  'dorka worktree create --name auth-pr-1',
  'dorka worktree create --name auth-pr-2',
  'dorka orchestration dispatch --task pr1 --to w1',
  'dorka orchestration dispatch --task pr2 --to w2'
]
