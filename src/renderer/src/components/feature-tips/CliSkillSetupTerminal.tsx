...
import { DORKA_CLI_ORCHESTRATION_SKILL_INSTALL_COMMAND } from '@/lib/agent-feature-install-commands'
    ...
    <div className="min-w-0">
      ...
      <OnboardingInlineCommandTerminal
        ...
        ariaLabel={translate(
          ...
          'Dorka CLI and orchestration skill install terminal'
        )}
        description={translate(
          'auto.components.feature.tips.CliSkillSetupTerminal.1953e90447',
          'Press Enter to install the Dorka CLI orchestration skill for your agents.'
        )}
