    ...
    <div className="mp-intro-shell">
      <div className="mp-eyebrow-row">
        <span className="mp-eyebrow">
          {translate('auto.components.mobile.MobileHero.5410d55d79', 'Dorka Mobile')}
        </span>
      </div>
      <h1 className="mp-h1">
        {translate(
      ...
      <p className="mp-lead">
        {translate(
          ...
          "Control Dorka from your phone. Check on agents, review changes, and kick off tasks while you're away from your desk."
        )}
      </p>
      <div
