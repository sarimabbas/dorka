      ...
      <div className="mp-app-topbar">
        <div className="mp-app-brand">
          ...
          <span className="mp-app-brand-name">
            {translate('auto.components.mobile.slides.HomeSlide.5d94e8ddcc', 'Dorka')}
          </span>
        </div>
        <button
          type="button"
...
function DorkaLogo(): React.JSX.Element {
  return (
    <svg className="mp-dorka-logo" viewBox="0 0 318.60232 202.66667" fill="currentColor" aria-hidden>
