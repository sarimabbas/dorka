...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Dorka Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Dorka Mobile')
  })

  it('labels the restore action explicitly when Dorka Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
