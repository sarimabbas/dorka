    ...
    <UsageTrackingPaneShell
      ...
      filterSections={[
        <UsageFilterRadioGroup
          ...
          value="dorka"
          options={[
            { value: 'dorka', label: 'Dorka worktrees only' },
      ...
      selectionSummary="Dorka worktrees only • Last 7 days"
...
describe('UsageTrackingPaneShell', () => {
  ...
  it('renders the empty state and wires header actions', async () => {
    ...
    expect(screen.getByText('Dorka worktrees only • Last 7 days')).toBeInTheDocument()
