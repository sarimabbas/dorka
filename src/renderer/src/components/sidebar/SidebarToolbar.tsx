...
const WORKSPACE_BOARD_MOVED_HINT_STORAGE_KEY = 'dorka.workspaceBoardMovedHintSeen.v1'
...
const SidebarToolbar = React.memo(function SidebarToolbar({
  ...
  // translate() preserves Dorka's pseudo-localization behavior. Without it the
