...
describe('SidebarNav', () => {
  ...
  it('updates localized labels when the language changes after mount', async () => {
    ...
    expect(queryButtonByText(container, 'Dorka Mobile')).not.toBeNull()
    ...
    expect(queryButtonByText(container, 'Dorka 手机端')).not.toBeNull()
  })
  ...
  it('shows the inline hide control only once a device is paired', async () => {
    ...
    expect(queryButtonByText(beforePairing, 'Dorka Mobile')).not.toBeNull()
  ...
  it('hides Mobile from its sidebar context menu', async () => {
    ...
    const mobileMenu = getButtonByText(container, 'Dorka Mobile').closest(
      '[data-testid="context-menu"]'
    )
