...
describe('delete worktree flow', () => {
  ...
  it('opens project removal confirmation for a primary workspace', () => {
    ...
    mocks.state.repos = [{ id: 'repo-1', displayName: 'dorka' }]
  ...
  it('routes primary workspace removal to its exact SSH host', () => {
    ...
    mocks.state.repos = [
      { id: 'repo-1', displayName: 'local dorka' },
      { id: 'repo-1', displayName: 'provisioned dorka', connectionId: 'runtime-ssh-one' }
    ]
