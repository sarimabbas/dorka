...
export default function HiddenWorktreeRecoveryList({
  ...
  const filtered = normalizedQuery
    ...
    : hidden
  const discoveredCount = hidden.length + getVisibleNonDorkaWorktrees(detected).length
              ...
              {normalizedQuery
                ...
                : discoveredCount > 0
                  ...
                  : translate(
                      ...
                      'New worktrees will appear here when Dorka detects them.'
                    )}
            </div>
          </div>
        </div>
