...
describe('getDefaultCloneParent', () => {
  it('strips a POSIX workspaces suffix', () => {
    expect(getDefaultCloneParent('/Users/mvanhorn/dorka/workspaces')).toBe('/Users/mvanhorn/dorka')
  })
  ...
  it('strips a Windows workspaces suffix', () => {
    expect(getDefaultCloneParent('C:\\Users\\mvanhorn\\dorka\\workspaces')).toBe(
      'C:\\Users\\mvanhorn\\dorka'
    )
  })
  ...
  it('strips repeated trailing separators before matching the suffix', () => {
    expect(getDefaultCloneParent('D:\\dorka\\workspaces\\\\')).toBe('D:\\dorka')
  })

  it('does not strip a similar-looking final segment', () => {
    expect(getDefaultCloneParent('/Users/mvanhorn/dorka/project-workspaces')).toBe(
      '/Users/mvanhorn/dorka/project-workspaces'
    )
  })
})
  ...
  it('fills the local clone destination from the workspace directory', () => {
    expect(
      getCloneDestinationAutoFill({
        ...
        workspaceDir: '/Users/mvanhorn/dorka/workspaces',
        cloneStepAutoFilled: false
      })
    ).toEqual({ destination: '/Users/mvanhorn/dorka' })
  })
