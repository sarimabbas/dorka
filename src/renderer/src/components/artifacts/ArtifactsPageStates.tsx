      ...
      {configured ? (
        <Button size="sm" onClick={onConnect}>
          {needsReconnect
            ...
            : translate('auto.components.artifacts.ArtifactsPage.signIn', 'Sign in to Dorka')}
        </Button>
      ) : (
        <div className="flex flex-col items-center gap-2">
          <p className="max-w-sm text-xs leading-5 text-muted-foreground">
            {translate(
              ...
              'Dorka account sign-in is not configured on this machine yet.'
            )}
          </p>
