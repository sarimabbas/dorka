...
function dispatchLoadFailure(
  ...
  Object.assign(event, {
    ...
    validatedURL: 'https://share.ondorka.dev/a/report',
...
describe('ArtifactPreview', () => {
  beforeEach(() => {
    Object.assign(window, {
      api: {
        browser: { sessionResolvePartition: vi.fn().mockResolvedValue('persist:dorka-default') }
      }
    })
  })
  ...
  it('ignores child-frame failures and aborted navigations', async () => {
    render(<ArtifactPreview shareUrl="https://share.ondorka.dev/a/report" />)
