...
function readPreviewFlag(): boolean {
  ...
  try {
    ...
    return window.localStorage.getItem('dorka-debug-show-signout-card') === '1'
  } catch {
    return false
  }
}
      ...
      >
        <div className="flex flex-col gap-2.5 p-3.5">
          ...
          <p className="text-sm text-muted-foreground">
            {email
              ? translate(
                  ...
                  'Sign in again as {{value0}} to restore Artifact sharing, Dorka Relay, and skill sharing.',
                  { value0: email }
                )
              : translate(
                  'auto.components.UnexpectedSignoutCard.5a1c8d3e6f',
                  'Sign in again to restore Artifact sharing, Dorka Relay, and skill sharing.'
                )}
          </p>
            ...
            <CollapsibleContent className="space-y-3 pt-2.5">
              <FeatureRow
                ...
                description={translate(
                  ...
                  'Publish HTML and Markdown files and manage every shared link from Dorka.'
                )}
              />
              <FeatureRow
                icon={Smartphone}
                title={translate('auto.components.UnexpectedSignoutCard.6e3f1a9c5b', 'Dorka Relay')}
                description={translate(
          ...
          <div className="mt-0.5 flex gap-2">
            ...
            >
              {translate('auto.components.UnexpectedSignoutCard.c5b3e8a17d', 'Sign in to Dorka')}
            </Button>
          </div>
        </div>
      </Card>
