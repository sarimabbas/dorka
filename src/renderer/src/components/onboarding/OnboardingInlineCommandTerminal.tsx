...
import {
  DORKA_TERMINAL_COMMAND_FINISHED_EVENT,
...
export function OnboardingInlineCommandTerminal({
  ...
  useEffect(() => {
    ...
    window.addEventListener(DORKA_TERMINAL_COMMAND_FINISHED_EVENT, handleCommandFinished)
    return () => {
      window.removeEventListener(DORKA_TERMINAL_COMMAND_FINISHED_EVENT, handleCommandFinished)
    }
