...
// import Dorka code, so it reports failed ctx.font assignments (the stuck-
...
;(globalThis as { __dorkaAtlasFontProbe?: (mismatch: AtlasFontProbeMismatch) => void })[
  '__dorkaAtlasFontProbe'
] = (mismatch) => {
