...
describe('connectPanePty', () => {
  ...
  it('clears pre-hook launch config when an Dorka-started command exits', async () => {
  ...
  it('confirms an Dorka-launched Droid fresh spawn in a no-OSC shell (Git Bash)', async () => {
