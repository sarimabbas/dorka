...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\dorka\\file.txt', 'windows')).toBe(
      'C:\\Users\\dorka\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\dorka\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\dorka\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\dorka\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\dorka\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.dorka/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.dorka/drops/my file'\\''s $draft.txt'"
    )
  })
})
