// One-paste freeze report: `await window.__dorkaTerminalFreezeReport()` in the
...
type TerminalFreezeReportWindow = Window & {
  __dorkaTerminalFreezeReport?: () => Promise<TerminalFreezeReport>
}
...
export function installTerminalFreezeReport(): void {
  ...
  ;(window as TerminalFreezeReportWindow).__dorkaTerminalFreezeReport = buildTerminalFreezeReport
}
