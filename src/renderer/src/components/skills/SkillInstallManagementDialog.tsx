    ...
    try {
      ...
      setError(
        translate(
          ...
          'Dorka could not inspect managed installs on this machine.'
        )
      )
    } finally {
      if (generation === loadGeneration.current) {
        ...
        setError(
          operation.status === 'reconnect-required'
            ? translate(
                ...
                'Reconnect your Dorka account to load version history.'
              )
            : operation.message
        )
        return
    ...
    try {
          ...
          setError(
            operation.status === 'reconnect-required'
              ? translate(
                  ...
                  'Reconnect your Dorka account before changing versions.'
                )
              : operation.message
          )
          return
      ...
      setError(
        translate(
          ...
          'Dorka could not verify the requested version.'
        )
      )
    } finally {
    ...
    try {
      ...
      setError(
        translate(
          ...
          'Dorka could not safely remove this skill.'
        )
      )
    } finally {
      setBusy(false)
