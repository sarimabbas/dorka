  ...
  switch (reason) {
    case 'bundled': {
      return translate(
        ...
        'Bundled with Dorka — it would be restored'
      )
    }
    case 'plugin': {
      return translate(
    ...
    case 'unowned': {
      return translate(
        ...
        'This skill lives outside Dorka’s skill folders — delete it where it is stored'
      )
    }
    case 'missing': {
      return translate(
...
/**
 * A skill whose content lives outside every Dorka root is removed by its links
