...
function placement(
  ...
  return {
    ...
    unresolvedPath: '/home/.agents/skills/dorka-cli',
    resolvedPath: '/home/.agents/skills/dorka-cli',
    physicalIdentity: 'physical-dorka-cli',
...
const DISMISSAL_KEY = ['physical-dorka-cli', 'dorka-cli', '2'].join('\0')
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          unresolvedPath: '/home/projects/work/.agents/skills/dorka-cli',
          resolvedPath: '/home/projects/work/.agents/skills/dorka-cli',
          physicalIdentity: 'physical-repo-dorka-cli'
        })
      ],
      eligibleUpdateNames: ['dorka-cli'],
      scanIssues: [],
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          physicalIdentity: 'physical-repo-dorka-cli-after-checkout'
        })
      ],
      eligibleUpdateNames: ['dorka-cli'],
      scanIssues: [],
