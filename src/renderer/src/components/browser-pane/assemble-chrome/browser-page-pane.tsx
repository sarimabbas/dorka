...
export function BrowserPagePane({
  ...
  const isBlankTab = browserTab.url === 'about:blank' || browserTab.url === DORKA_BROWSER_BLANK_URL
      ...
      {pageViewport?.container
        ? createPortal(
            <BrowserPageViewportOverlays
              ...
              sshRouted={Boolean(sessionPartition?.startsWith('persist:dorka-browser-v1-'))}
              isBlankTab={isBlankTab}
