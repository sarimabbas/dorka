export const DORKA_TERMINAL_COMMAND_FINISHED_EVENT = 'dorka:terminal-command-finished'
...
export function dispatchTerminalCommandFinishedEvent(
  ...
  window.dispatchEvent(
    new CustomEvent<TerminalCommandFinishedEventDetail>(DORKA_TERMINAL_COMMAND_FINISHED_EVENT, {
