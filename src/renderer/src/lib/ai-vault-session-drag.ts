...
export const AI_VAULT_SESSION_DRAG_TYPE = 'application/x-dorka-ai-vault-session'
export const AI_VAULT_SESSION_DRAG_START_EVENT = 'dorka-ai-vault-session-drag-start'
export const AI_VAULT_SESSION_DRAG_END_EVENT = 'dorka-ai-vault-session-drag-end'
...
export function writeAiVaultSessionDragData(
  ...
  // resume command instead of letting Dorka's pane drop layer handle it.
