...
export const APP_MENU_PASTE_EVENT = 'dorka-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control Dorka already resolved.
  ...
  // Why: for text controls Dorka has already resolved ownership. Falling back
