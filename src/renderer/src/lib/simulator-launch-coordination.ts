...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'dorka:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'dorka:emulator-launch-failed'
