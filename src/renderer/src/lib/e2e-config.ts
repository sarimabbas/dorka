...
export const e2eDisableRemoteTerminalStallRecovery =
  ...
  rendererE2EQuery?.get('dorkaE2EDisableRemoteTerminalStallRecovery') === '1'
const rendererFallbackE2EConfig = createE2EConfig({
  exposeStore: rendererE2EExposeStore,
  terminalParkingDelayMs: Number(rendererE2EQuery?.get('dorkaE2ETerminalParkingDelayMs')) || null,
  terminalRetentionLimit: Number(rendererE2EQuery?.get('dorkaE2ETerminalRetentionLimit')) || null
})
