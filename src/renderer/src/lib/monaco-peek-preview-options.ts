...
type ReferenceWidgetConstructor = {
  prototype: ReferenceWidgetInstance & {
    __dorkaPeekPreviewOptionsInstalled?: true
  }
}

function applyPeekReferencesPreviewOptions(editor: PeekPreviewEditor | undefined): void {
  // Why: Monaco embedded editors inherit Dorka's full-editor options first.
...
export function installMonacoPeekReferencesPreviewOptions(
  ...
  if (prototype.__dorkaPeekPreviewOptionsInstalled) {
    return
  }
  ...
  prototype.__dorkaPeekPreviewOptionsInstalled = true
}
