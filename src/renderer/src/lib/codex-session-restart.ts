...
export type CodexPaneScanResult = {
  ...
  /** Dorka launched Codex in this tab, so a shell foreground can still be reattach settle. */
 ...
 * Gated to Dorka-launched Codex panes so an account switch never spends the
 ...
 * baked into their environment. Without this, quitting Dorka before restarting a
