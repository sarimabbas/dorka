...
describe('markdown document templates', () => {
  ...
  it('discovers markdown files under .dorka/templates and skips unsafe entries', async () => {
    const readDir = stubReadDir({
      '/repo/.dorka/templates': [
        entry('daily-note.md'),
        entry('scratch.txt'),
      ...
      '/repo/.dorka/templates/nested': [entry('meeting.markdown'), entry('brief.mdx')]
    })
    ...
    await expect(
      ...
      {
        id: '.dorka/templates/nested/brief.mdx',
        name: 'Brief',
        filePath: '/repo/.dorka/templates/nested/brief.mdx',
        relativePath: '.dorka/templates/nested/brief.mdx',
        templateRelativePath: 'nested/brief.mdx',
        basename: 'brief.mdx'
      },
      {
        id: '.dorka/templates/daily-note.md',
        name: 'Daily note',
        filePath: '/repo/.dorka/templates/daily-note.md',
        relativePath: '.dorka/templates/daily-note.md',
        templateRelativePath: 'daily-note.md',
        basename: 'daily-note.md'
      },
      {
        id: '.dorka/templates/nested/meeting.markdown',
        name: 'Meeting',
        filePath: '/repo/.dorka/templates/nested/meeting.markdown',
        relativePath: '.dorka/templates/nested/meeting.markdown',
  ...
  it('keeps Windows file paths native while exposing root-relative template paths', async () => {
    stubReadDir({
      'C:\\repo\\.dorka\\templates': [entry('daily.md')]
    })
    ...
    await expect(
      ...
      {
        id: '.dorka/templates/daily.md',
        name: 'Daily',
        filePath: 'C:\\repo\\.dorka\\templates\\daily.md',
        relativePath: '.dorka/templates/daily.md',
