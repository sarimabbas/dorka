...
// Why: when a repo has no `dorka.yaml` issueCommand and no per-user override,
...
function getDefaultTabCommandPreview(yamlHooks: DorkaHooks | null): string {
 ...
 * their `dorka.yaml` / `.dorka/issue-command` yet.
 */
