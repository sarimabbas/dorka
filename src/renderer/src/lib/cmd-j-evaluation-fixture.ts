...
export const CMD_J_FIXTURE_PORTS: ReadonlyMap<string, { port: number; processName?: string }[]> =
  new Map([
    ['wt-main-dorka', [{ port: 3000, processName: 'node' }]],
...
export const CMD_J_FIXTURE_CASES: readonly CmdJFixtureCase[] = [
  ...
  { query: 'main 3000', expected: ['wt-main-dorka'] },
  { query: 'acme/dorka main', expected: ['wt-main-dorka'] },
  { query: 'dorka/main', expected: ['wt-main-dorka'] },
