...
type GuardedDelayerPrototype = MonacoDelayerInstance & {
  __dorkaDelayerCancellationGuardInstalled?: true
}
...
export function installMonacoDelayerCancellationGuard(): void {
  ...
  if (delayerPrototype.__dorkaDelayerCancellationGuardInstalled) {
    return
  }
  ...
  delayerPrototype.__dorkaDelayerCancellationGuardInstalled = true
}
