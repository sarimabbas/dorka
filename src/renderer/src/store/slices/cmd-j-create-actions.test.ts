...
vi.mock('@/lib/web-client-location', () => ({
  isWebClientLocation: () =>
    Boolean((globalThis as { __DORKA_WEB_CLIENT__?: boolean }).__DORKA_WEB_CLIENT__)
}))

const pairedWebFlag = globalThis as { __DORKA_WEB_CLIENT__?: boolean }
