...
export const dorkaProfileFindProjectProfiles: Mock = vi.fn()
...
export function installReposRuntimeRoutingHarness(): void {
  beforeEach(() => {
    ...
    ptyKill.mockReset()
    dorkaProfileFindProjectProfiles.mockReset()
    ...
    vi.stubGlobal('window', {
      api: {
        ...
        dorkaProfiles: {
          findProjectProfiles: dorkaProfileFindProjectProfiles
        },
        pty: { kill: ptyKill },
