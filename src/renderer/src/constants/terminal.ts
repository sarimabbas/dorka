...
export const TOGGLE_TERMINAL_PANE_EXPAND_EVENT = 'dorka-toggle-terminal-pane-expand'
export const FOCUS_TERMINAL_PANE_EVENT = 'dorka-focus-terminal-pane'
export const PASTE_TERMINAL_TEXT_EVENT = 'dorka-paste-terminal-text'
export const SPLIT_TERMINAL_PANE_EVENT = 'dorka-split-terminal-pane'
export const REQUEST_ACTIVE_TERMINAL_PANE_SPLIT_EVENT = 'dorka-request-active-terminal-pane-split'
export const CLOSE_TERMINAL_PANE_EVENT = 'dorka-close-terminal-pane'
export const BACKGROUND_MOUNT_TERMINAL_WORKTREE_EVENT = 'dorka-background-mount-terminal-worktree'
...
export const WAKE_HIBERNATED_AGENTS_WORKTREE_EVENT = 'dorka-wake-hibernated-agents-worktree'
...
export const SYNC_FIT_PANES_EVENT = 'dorka-sync-fit-panes'
