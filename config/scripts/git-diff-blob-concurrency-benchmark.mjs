...
const ITERATIONS = Number(process.env.DORKA_DIFF_BLOB_BENCH_ITERATIONS ?? '10')
const WARMUP = Number(process.env.DORKA_DIFF_BLOB_BENCH_WARMUP ?? '3')

for (const [name, value] of [
  ['DORKA_DIFF_BLOB_BENCH_ITERATIONS', ITERATIONS],
  ['DORKA_DIFF_BLOB_BENCH_WARMUP', WARMUP]
]) {
