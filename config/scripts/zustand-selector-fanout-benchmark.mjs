...
const SUBSCRIBERS = Number.parseInt(process.env.DORKA_ZUSTAND_BENCH_SUBSCRIBERS ?? '2500', 10)
const WRITES = Number.parseInt(process.env.DORKA_ZUSTAND_BENCH_WRITES ?? '2000', 10)
const MAX_MILLISECONDS_PER_WRITE = Number.parseFloat(
  process.env.DORKA_ZUSTAND_BENCH_MAX_MS_PER_WRITE ?? '5'
)

for (const [name, value] of [
  ['DORKA_ZUSTAND_BENCH_SUBSCRIBERS', SUBSCRIBERS],
  ['DORKA_ZUSTAND_BENCH_WRITES', WRITES],
  ['DORKA_ZUSTAND_BENCH_MAX_MS_PER_WRITE', MAX_MILLISECONDS_PER_WRITE]
]) {
