...
describe('computer-use e2e workflow', () => {
  ...
  it('guards e2e source against fragile waits and Windows Calculator drift', () => {
    ...
    expect(cliDriver).toContain('DORKA_DEV_USER_DATA_PATH')
    expect(cliDriver).toContain('dorka-computer-runtime-')
    expect(cliDriver).toContain('retryMissingRuntimeMetadata')
    expect(cliDriver).toContain('Could not read Dorka runtime metadata')
