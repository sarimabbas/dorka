...
const ROUNDS = Number(process.env.DORKA_SESSION_WRITE_BENCH_ROUNDS ?? '9')
const LEAVES = Number(process.env.DORKA_SESSION_WRITE_BENCH_LEAVES ?? '8')
const PANE_KEYS = Number(process.env.DORKA_SESSION_WRITE_BENCH_PANE_KEYS ?? '2000')

for (const [name, value] of [
  ['DORKA_SESSION_WRITE_BENCH_ROUNDS', ROUNDS],
  ['DORKA_SESSION_WRITE_BENCH_LEAVES', LEAVES],
  ['DORKA_SESSION_WRITE_BENCH_PANE_KEYS', PANE_KEYS]
]) {
