...
const ROWS = Number.parseInt(process.env.DORKA_OWNER_SETTINGS_BENCH_ROWS ?? '43', 10)
const WRITES = Number.parseInt(process.env.DORKA_OWNER_SETTINGS_BENCH_WRITES ?? '2000', 10)
const WARMUP = Number.parseInt(process.env.DORKA_OWNER_SETTINGS_BENCH_WARMUP ?? '200', 10)

for (const [name, value] of [
  ['DORKA_OWNER_SETTINGS_BENCH_ROWS', ROWS],
  ['DORKA_OWNER_SETTINGS_BENCH_WRITES', WRITES],
  ['DORKA_OWNER_SETTINGS_BENCH_WARMUP', WARMUP]
]) {
