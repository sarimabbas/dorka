...
const markerPath = process.env.DORKA_REPRO_SPAWN_MARKER
const exitTriggerPath = process.env.DORKA_REPRO_EXIT_TRIGGER
const inputMarkerPath = process.env.DORKA_REPRO_INPUT_MARKER
const agentSessionToken = process.env.DORKA_REPRO_AGENT_SESSION_TOKEN
