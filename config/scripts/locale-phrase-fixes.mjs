...
export const LOCALE_PHRASE_FIXES = {
  ...
  zh: [
    ...
    { pattern: /虎鲸:\/\//g, replacement: 'dorka://', whenEnIncludes: 'dorka://' },
    ...
    { pattern: /连接到Dorka/g, replacement: '连接到 Dorka', whenEnIncludes: 'Connect to Dorka' },
    {
      pattern: /开始使用Dorka/g,
      replacement: '开始使用 Dorka',
      whenEnIncludes: 'get started with Dorka'
    },
