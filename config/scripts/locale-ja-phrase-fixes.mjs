...
// Two-word commands (`git commit`, `dorka terminal`) must keep their second word in Latin.
const COMMAND_HEAD = '(?<!\\b(?:git|gh|glab|dorka|npm|pnpm|npx|yarn|docker|kubectl) )'
...
export const JA_PHRASE_FIXES = [
  ...
  { pattern: /シャチ:\/\//g, replacement: 'dorka://', whenEnIncludes: 'dorka://' },
  ...
  { pattern: /崩壊させる/g, replacement: '折りたたむ', whenEnIncludes: 'Collapse Dorka' },
  ...
  { pattern: /再起動します/g, replacement: '再起動', whenEnIncludes: 'Restart Dorka' },
  ...
  // Dorka's host covers SSH hosts and this computer; skipped where the English also says server.
  {
