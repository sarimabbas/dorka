...
// Asserts that the telemetry compile-time constants — `DORKA_BUILD_IDENTITY`
// and `DORKA_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Dorka.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Dorka.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `DORKA_BUILD_IDENTITY` and `DORKA_POSTHOG_WRITE_KEY` with their
