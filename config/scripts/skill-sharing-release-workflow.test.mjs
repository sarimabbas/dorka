...
describe('skill-sharing release workflow', () => {
  ...
  it('runs the focused contract and transaction suite with real Windows coverage', () => {
    ...
    expect(platformTest.env.DORKA_REAL_WINDOWS_SKILL_TEST).toContain("runner.os == 'Windows'")
    expect(platformTest.env.DORKA_REAL_PROCESS_SKILL_TEST).toBe('1')
    expect(linuxTest.env.DORKA_REAL_PROCESS_SKILL_TEST).toBe('1')
