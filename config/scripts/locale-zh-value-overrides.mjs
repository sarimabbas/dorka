...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Dorka IDE': 'Dorka IDE',
  'Dorka first': 'Dorka 优先',
  'Dorka Mobile': 'Dorka Mobile',
  'Dorka logo': 'Dorka 标志',
  'Enjoying Dorka?': '喜欢 Dorka 吗？',
  'Get to know Dorka': '了解 Dorka',
  'Expand Dorka': '展开 Dorka',
  'Support Dorka': '支持 Dorka',
  'Restarting Dorka…': '正在重启 Dorka…',
  'Show Dorka Mobile Button': '显示 Dorka Mobile 按钮',
  ...
  "Give agents direct access to Dorka's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Dorka 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Dorka. It is still on your disk.': '来自 Dorka。它仍保留在您的磁盘上。',
