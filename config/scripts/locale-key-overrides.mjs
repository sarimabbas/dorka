...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'menu.showMobileButton': {
    ko: 'Dorka 모바일 버튼 표시',
    zh: '显示 Dorka Mobile 按钮',
    ja: 'Dorka Mobile ボタンを表示'
  },
  ...
  'menu.exploreDorka': { ko: 'Dorka 둘러보기', zh: '探索 Dorka', ja: 'Dorka を探索' },
  ...
  // Onboarding pill beside Dorka Mobile: "New" marks a new feature, not a create action.
