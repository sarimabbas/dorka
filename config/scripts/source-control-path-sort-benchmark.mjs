...
const ITERATIONS = Number(process.env.DORKA_SC_SORT_BENCH_ITERATIONS ?? '25')
const WARMUP = Number(process.env.DORKA_SC_SORT_BENCH_WARMUP ?? '5')

for (const [name, value] of [
  ['DORKA_SC_SORT_BENCH_ITERATIONS', ITERATIONS],
  ['DORKA_SC_SORT_BENCH_WARMUP', WARMUP]
]) {
