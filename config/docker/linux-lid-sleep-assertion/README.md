...
```sh
DORKA_BACKGROUND_LAUNCH=1 node config/scripts/run-linux-lid-sleep-assertion-docker.mjs --baseline <git-ref>
```
...
`DORKA_DOCKER` and `DORKA_DOCKER_PLATFORM` override the executable and architecture.
