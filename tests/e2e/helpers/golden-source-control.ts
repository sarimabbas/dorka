...
export const GOLDEN_GIT_AUTHOR_NAME = 'Dorka E2E'
export const GOLDEN_GIT_AUTHOR_EMAIL = 'dorka-e2e@example.invalid'
...
export function installPassingNodePreCommitHook(fixture: GoldenWorktree): string {
  const hooksPath = mkdtempSync(path.join(os.tmpdir(), 'dorka-e2e-git-hooks-'))
