...
export const FIXTURE_COMMENTS: PRComment[] = [
  {
    ...
    url: 'https://github.com/acme/dorka/pull/73#discussion_r101',
  ...
  },
  {
    ...
    url: 'https://github.com/acme/dorka/pull/73#issuecomment-102',
  ...
  },
  {
    ...
    url: 'https://github.com/acme/dorka/pull/73#discussion_r103',
...
export async function seedPRCommentsSidebarFixture(page: Page): Promise<PRCommentsSidebarSeed> {
  return page.evaluate(async (fixtureComments: PRComment[]) => {
    ...
    const pr: PRInfo = {
      ...
      state: 'open',
      url: `https://github.com/acme/dorka/pull/${prNumber}`,
      checksStatus: 'pending',
      updatedAt: '2026-05-15T00:00:00.000Z',
      mergeable: 'MERGEABLE',
      prRepo: { owner: 'acme', repo: 'dorka' }
    }
    ...
    window.localStorage.setItem('dorka:pr-comment-presentation', 'cards')
