...
const REMOTE_TUI_PATH = '/tmp/dorka-codex-display-artifacts-repro.mjs'
export const REMOTE_TUI_DONE = 'DORKA_REMOTE_CODEX_ARTIFACT_TUI_DONE'
...
const REMOTE_CODEX_FIXTURE_FRAMES = parseEnvNumber(process.env.DORKA_E2E_CODEX_FIXTURE_FRAMES, 34)
const REMOTE_CODEX_FIXTURE_FRAME_DELAY_MS = parseEnvNumber(
  process.env.DORKA_E2E_CODEX_FIXTURE_FRAME_DELAY_MS,
  45
)
...
await write('If Dorka leaves wide gray rectangles here, they are stale remote-PTY render artifacts.\\r\\n')
...
const marker = process.argv.join(' ').match(/DORKA_REMOTE_CODEX_ARTIFACT_TUI_DONE|DORKA_REAL_REMOTE_CODEX_DONE_[0-9]+/)?.[0] || '${REMOTE_TUI_DONE}'
const scrollTop = 1
...
await write('Tip: deterministic fixture for Dorka SSH Codex display artifacts.\\r\\n\\r\\n')
