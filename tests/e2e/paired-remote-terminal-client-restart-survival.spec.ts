 ...
 *
 * TOPOLOGY: the `dorkaPage` app is the host (dorka server); a separate real Dorka desktop client
...
const scratch = mkdtempSync(path.join(os.tmpdir(), 'dorka-client-restart-survival-'))
