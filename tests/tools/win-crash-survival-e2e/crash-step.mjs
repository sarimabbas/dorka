...
//
// GitHub #7742: when Dorka's main/renderer process died on Windows, the terminal
 ...
 * or image-named process, so a live user Dorka on the same box is never touched.
 */
