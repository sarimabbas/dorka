...
Run `DORKA_BACKGROUND_LAUNCH=1 node tests/tools/omp-picker-search-rendered/run.mjs`.
...
catalog without search aliases and `DORKA_OMP_PICKER_BASELINE=1`, expecting no match.
