...
// irreducible core (Dorka.exe needs icu + snapshots even as node; the daemon
...
export function resolveTierFileSet(inv, tier) {
  ...
  // Core: exe + runtime data blobs live next to Dorka.exe in win-unpacked.
  addFile(inv.hostExe, 'Dorka.exe')
