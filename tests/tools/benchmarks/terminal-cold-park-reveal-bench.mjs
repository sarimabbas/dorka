...
// DORKA_E2E_TERMINAL_PARKING_DELAY_MS override to shrink the 30s hysteresis and
...
function createLocalRepoFixture() {
  ...
  git(repoPath, 'config', 'user.email', 'bench@dorka.local')
  git(repoPath, 'config', 'user.name', 'Dorka Bench')
