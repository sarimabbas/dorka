...
const report = {
  scope:
    'Production selector, row builder and compact sidebar rows; injected status with no tabs, then status removal. No live SSH/paired transport or full Dorka shell.'
}
try {
