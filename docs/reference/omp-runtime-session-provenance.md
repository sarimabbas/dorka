...
The remaining child-first case is inherently ambiguous to Dorka: task children and
...
session reaches Dorka's callback before any child. An earlier user extension can
