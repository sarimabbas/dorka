...
Dorka skill sharing. The operator runbook remains the source of truth for incident commands and
environment-specific procedures.

## Access model

- Shared bundles are unlisted bearer resources. Dorka provides no public browse, search, recipient
...
another current member can manage the package after its publisher leaves; Dorka does not rewrite
...
See the Dorka Cloud `docs/skill-sharing-runbook.md` for deployment controls, reconciliation,
