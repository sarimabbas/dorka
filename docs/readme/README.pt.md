...
<p align="center">
  ...
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Entre no Discord do Dorka" /></a>
  <a href="https://x.com/dorka_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="Siga o Dorka no X" /></a>
...
<h3 align="center"><a href="https://ondorka.dev/download"><ins>Baixar o Dorka</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="App desktop do Dorka executando agentes em worktrees paralelos, com o app companion móvel do Dorka no canto" width="960" />
</p>
...
[App Store para iOS](https://apps.apple.com/us/app/dorka-ide/id6766130217) · [TestFlight](https://testflight.apple.com/join/YjeGMQBA) · [APK Android 0.0.48](https://github.com/stablyai/orca/releases/download/mobile-android-v0.0.48/app-release.apk) · [Docs →](https://www.ondorka.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Dorka desktop com o app companion móvel" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.ondorka.dev/docs/model/worktrees"><picture><source srcset="../site/public/docs/tab-split.gif" type="image/gif"><img src="../site/public/docs/posters/tab-split.jpg" alt="Orquestração de worktrees paralelos" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.ondorka.dev/docs/terminal"><picture><source srcset="../../resources/onboarding/feature-wall/tile-02.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-02.poster.jpg" alt="Terminais divididos" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.ondorka.dev/docs/browser/design-mode"><picture><source srcset="../site/public/docs/dorka-design-mode.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-05.poster.jpg" alt="Navegador integrado e Modo Design" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.ondorka.dev/docs/review/linear"><picture><source srcset="../../resources/onboarding/feature-wall/tile-03.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-03.poster.jpg" alt="Fluxos de trabalho de tarefas do GitHub e Linear no Dorka" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.ondorka.dev/docs/ssh"><picture><source srcset="../../resources/onboarding/feature-wall/tile-06.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-06.poster.jpg" alt="Worktrees remotos por SSH" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Deixe comentários em qualquer linha de diff e envie-os de volta ao agente — revise, edite e faça commit sem sair do Dorka.

[Docs →](https://www.ondorka.dev/docs/review/annotate-ai-diff)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/review/annotate-ai-diff"><picture><source srcset="../site/public/docs/annotate-ai-diff.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-08.poster.jpg" alt="Anotar diffs gerados por IA" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.ondorka.dev/docs/editing/file-explorer"><picture><source srcset="../../resources/onboarding/feature-wall/tile-07.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-07.poster.jpg" alt="Arraste arquivos e imagens para o prompt de um agente" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Agentes também controlam o Dorka — automatize qualquer fluxo de trabalho com `dorka worktree create`, `snapshot`, `click` e `fill`.

[Docs →](https://www.ondorka.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/cli/overview"><picture><source srcset="../../resources/onboarding/feature-wall/tile-09.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-09.poster.jpg" alt="Automatize o Dorka pela CLI" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **[Abertura rápida](https://www.ondorka.dev/docs/model/quick-open)** — Pesquise entre worktrees, arquivos, agentes, comandos e contexto do repositório sem sair do seu fluxo.
- **[Troca de contas e acompanhamento de uso](https://www.ondorka.dev/docs/agents/usage-tracking)** — Veja o uso de Claude e Codex, os reinícios de limites e troque contas instantaneamente sem fazer login de novo.
- **[Prévias ricas do repositório](https://www.ondorka.dev/docs/editing/markdown)** — Pré-visualize Markdown, imagens, PDFs e documentos do repositório no workspace.
- **[Computer Use](https://www.ondorka.dev/docs/cli/computer-use)** — Deixe agentes operarem apps de desktop e UI visível quando um fluxo de trabalho precisa de interação real.
- **[Notificações e estado de não lido](https://www.ondorka.dev/docs/notifications)** — Saiba quando um agente termina ou precisa de atenção, depois marque conversas como não lidas para voltar depois.
...
Funciona com **qualquer agente CLI** — se roda em um terminal, roda no Dorka.
...
- **[Baixe em onDorka.dev](https://ondorka.dev/download)**
- Ou baixe um build diretamente: [macOS Apple Silicon](https://github.com/stablyai/orca/releases/latest/download/dorka-macos-arm64.dmg) · [macOS Intel](https://github.com/stablyai/orca/releases/latest/download/dorka-macos-x64.dmg) · [Windows (.exe)](https://github.com/stablyai/orca/releases/latest/download/dorka-windows-setup.exe) · [Linux AppImage](https://github.com/stablyai/orca/releases/latest/download/dorka-linux.AppImage) · [Todos os builds](https://github.com/stablyai/orca/releases/latest)
- Rodando `dorka serve` em um servidor Linux headless? Veja o [guia de servidor Linux headless](../reference/headless-linux-server.md).
...
# Arch Linux (AUR) — ou stably-dorka-git para compilar a partir do código-fonte
...
- **iOS:** [Baixar na App Store](https://apps.apple.com/us/app/dorka-ide/id6766130217) ou [entrar no TestFlight](https://testflight.apple.com/join/YjeGMQBA)
...
- **Twitter / X:** Siga **[@dorka_build](https://x.com/dorka_build)** para atualizações e anúncios.
- **Feedback e ideias:** Lançamos rápido. Sentiu falta de algo? [Peça um novo recurso](https://github.com/stablyai/orca/issues).
- **Privacidade:** Veja a [documentação de privacidade e telemetria](https://www.ondorka.dev/docs/telemetry) para saber quais dados anônimos de uso o Dorka coleta e como desativar.
...
<a href="https://github.com/stablyai/orca/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=stablyai/orca" alt="Contribuidores do Dorka" />
</a>

## Licença

Dorka é livre e de código aberto sob a [Licença MIT](../../LICENSE).
