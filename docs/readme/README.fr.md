...
<p align="center">
  ...
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Rejoindre le Discord Dorka" /></a>
  <a href="https://x.com/dorka_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="Suivre Dorka sur X" /></a>
...
<h3 align="center"><a href="https://ondorka.dev/download"><ins>Télécharger Dorka</ins></a></h3>
...
<p align="center">
  <img src="../assets/readme-hero.jpg" alt="Application de bureau Dorka exécutant des agents dans des worktrees parallèles, avec l'app companion mobile Dorka dans le coin" width="960" />
</p>
...
[App Store iOS](https://apps.apple.com/us/app/dorka-ide/id6766130217) · [TestFlight](https://testflight.apple.com/join/YjeGMQBA) · [APK Android 0.0.48](https://github.com/stablyai/orca/releases/download/mobile-android-v0.0.48/app-release.apk) · [Docs →](https://www.ondorka.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Dorka desktop avec l'app companion mobile" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Docs →](https://www.ondorka.dev/docs/model/worktrees)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/model/worktrees"><picture><source srcset="../site/public/docs/tab-split.gif" type="image/gif"><img src="../site/public/docs/posters/tab-split.jpg" alt="Orchestration de worktrees parallèles" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Docs →](https://www.ondorka.dev/docs/terminal)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/terminal"><picture><source srcset="../../resources/onboarding/feature-wall/tile-02.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-02.poster.jpg" alt="Splits de terminal" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Docs →](https://www.ondorka.dev/docs/browser/design-mode)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/browser/design-mode"><picture><source srcset="../site/public/docs/dorka-design-mode.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-05.poster.jpg" alt="Navigateur intégré et Mode Design" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Docs →](https://www.ondorka.dev/docs/review/linear)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/review/linear"><picture><source srcset="../../resources/onboarding/feature-wall/tile-03.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-03.poster.jpg" alt="Workflows GitHub et Linear dans Dorka" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Docs →](https://www.ondorka.dev/docs/ssh)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/ssh"><picture><source srcset="../../resources/onboarding/feature-wall/tile-06.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-06.poster.jpg" alt="Worktrees distants via SSH" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Posez des commentaires sur n'importe quelle ligne de diff et renvoyez-les à l'agent — review, édition et commit sans quitter Dorka.

[Docs →](https://www.ondorka.dev/docs/review/annotate-ai-diff)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/review/annotate-ai-diff"><picture><source srcset="../site/public/docs/annotate-ai-diff.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-08.poster.jpg" alt="Annoter les diffs générés par l'IA" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Docs →](https://www.ondorka.dev/docs/editing/file-explorer)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/editing/file-explorer"><picture><source srcset="../../resources/onboarding/feature-wall/tile-07.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-07.poster.jpg" alt="Glisser des fichiers et images dans le prompt d'un agent" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Les agents pilotent aussi Dorka — scriptez n'importe quel workflow avec `dorka worktree create`, `snapshot`, `click` et `fill`.

[Docs →](https://www.ondorka.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/cli/overview"><picture><source srcset="../../resources/onboarding/feature-wall/tile-09.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-09.poster.jpg" alt="Scripter Dorka depuis la CLI" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **[Quick open](https://www.ondorka.dev/docs/model/quick-open)** — Cherchez parmi worktrees, fichiers, agents, commandes et contexte du repo sans quitter votre flow.
- **[Sélecteur de comptes &amp; suivi d'usage](https://www.ondorka.dev/docs/agents/usage-tracking)** — Suivez l'usage Claude et Codex et les resets de rate limit, et basculez de compte à chaud sans vous reconnecter.
- **[Aperçus riches du repo](https://www.ondorka.dev/docs/editing/markdown)** — Prévisualisez Markdown, images, PDF et docs du repo dans le workspace.
- **[Computer Use](https://www.ondorka.dev/docs/cli/computer-use)** — Laissez les agents piloter des apps desktop et l'UI visible quand un workflow demande une vraie interaction.
- **[Notifications et non-lus](https://www.ondorka.dev/docs/notifications)** — Sachez quand un agent termine ou a besoin d'attention, puis marquez des fils comme non lus pour y revenir plus tard.
...
Fonctionne avec **n'importe quel agent CLI** — s'il tourne dans un terminal, il tourne dans Dorka.
...
- **[Télécharger depuis onDorka.dev](https://ondorka.dev/download)**
- Ou récupérez un build directement : [macOS Apple Silicon](https://github.com/stablyai/orca/releases/latest/download/dorka-macos-arm64.dmg) · [macOS Intel](https://github.com/stablyai/orca/releases/latest/download/dorka-macos-x64.dmg) · [Windows (.exe)](https://github.com/stablyai/orca/releases/download/v1.4.147-rc.3/dorka-windows-setup.exe) · [Linux AppImage](https://github.com/stablyai/orca/releases/latest/download/dorka-linux.AppImage) · [Tous les builds](https://github.com/stablyai/orca/releases/latest)
...
- Vous lancez `dorka serve` sur un serveur Linux headless ? Consultez le [guide serveur Linux headless](../reference/headless-linux-server.md).
...
# Arch Linux (AUR) — ou stably-dorka-git pour compiler depuis les sources
...
- **iOS :** [Télécharger sur l'App Store](https://apps.apple.com/us/app/dorka-ide/id6766130217) ou [rejoindre TestFlight](https://testflight.apple.com/join/YjeGMQBA)
...
- **Twitter / X :** Suivez **[@dorka_build](https://x.com/dorka_build)** pour les news et annonces.
- **WeChat :** Scannez pour rejoindre le groupe WeChat 10 de la communauté Dorka.

  <img src="../assets/wechat-qr-group10.jpg" alt="QR code WeChat groupe 10 de la communauté Dorka" width="160" />

- **Feedback &amp; idées :** On ship vite. Il manque quelque chose ? [Demandez une feature](https://github.com/stablyai/orca/issues).
- **Confidentialité :** Voir la [doc confidentialité &amp; télémétrie](https://www.ondorka.dev/docs/telemetry) pour ce qu'Dorka collecte en anonyme et comment désactiver la télémétrie.
...
<a href="https://github.com/stablyai/orca/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=stablyai/orca" alt="Contributeurs Dorka" />
</a>
...
Dorka est libre et open source sous la [licence MIT](../../LICENSE).
