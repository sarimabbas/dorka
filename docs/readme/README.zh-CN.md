...
<p align="center">
  ...
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="加入 Dorka Discord" /></a>
  <a href="https://x.com/dorka_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="在 X 上关注 Dorka" /></a>
...
<h3 align="center"><a href="https://ondorka.dev/download"><ins>下载 Dorka</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="Dorka 桌面应用在并行 worktree 中运行智能体，角落里是 Dorka 移动 companion 应用" width="960" />
</p>
...
[iOS App Store](https://apps.apple.com/us/app/dorka-ide/id6766130217) · [Android APK](https://github.com/stablyai/orca/releases/download/mobile-android-v0.0.48/app-release.apk) · [文档 →](https://www.ondorka.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Dorka 桌面端与移动 companion 应用" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.ondorka.dev/docs/model/worktrees)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/model/worktrees"><picture><source srcset="../site/public/docs/tab-split.gif" type="image/gif"><img src="../site/public/docs/posters/tab-split.jpg" alt="并行 worktree 编排" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.ondorka.dev/docs/terminal)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/terminal"><picture><source srcset="../../resources/onboarding/feature-wall/tile-02.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-02.poster.jpg" alt="终端分屏" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.ondorka.dev/docs/browser/design-mode)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/browser/design-mode"><picture><source srcset="../site/public/docs/dorka-design-mode.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-05.poster.jpg" alt="内置浏览器与设计模式" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.ondorka.dev/docs/review/linear)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/review/linear"><picture><source srcset="../../resources/onboarding/feature-wall/tile-03.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-03.poster.jpg" alt="Dorka 中的 GitHub 与 Linear 任务工作流" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.ondorka.dev/docs/ssh)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/ssh"><picture><source srcset="../../resources/onboarding/feature-wall/tile-06.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-06.poster.jpg" alt="通过 SSH 使用远程 worktree" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
在任意 diff 行上添加评论并发回给智能体 — 评审、编辑、提交，全程无需离开 Dorka。

[文档 →](https://www.ondorka.dev/docs/review/annotate-ai-diff)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/review/annotate-ai-diff"><picture><source srcset="../site/public/docs/annotate-ai-diff.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-08.poster.jpg" alt="标注 AI 生成的 diff" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.ondorka.dev/docs/editing/file-explorer)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/editing/file-explorer"><picture><source srcset="../../resources/onboarding/feature-wall/tile-07.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-07.poster.jpg" alt="将文件和图片拖入智能体提示" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
智能体也能驱动 Dorka — 用 `dorka worktree create`、`snapshot`、`click` 和 `fill` 把每个工作流脚本化。

[文档 →](https://www.ondorka.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.ondorka.dev/docs/cli/overview"><picture><source srcset="../../resources/onboarding/feature-wall/tile-09.gif" type="image/gif"><img src="../../resources/onboarding/feature-wall/tile-09.poster.jpg" alt="从 CLI 脚本化 Dorka" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **[快速打开](https://www.ondorka.dev/docs/model/quick-open)** — 在 worktree、文件、智能体、命令和仓库上下文之间搜索，不打断你的心流。
- **[账号切换与用量追踪](https://www.ondorka.dev/docs/agents/usage-tracking)** — 查看 Claude 和 Codex 的用量与限额重置时间，并且无需重新登录即可热切换账号。
- **[丰富仓库预览](https://www.ondorka.dev/docs/editing/markdown)** — 在工作区中预览 Markdown、图片、PDF 和仓库文档。
- **[Computer Use](https://www.ondorka.dev/docs/cli/computer-use)** — 当工作流需要真实交互时，让智能体操作桌面应用和可见 UI。
- **[通知与未读状态](https://www.ondorka.dev/docs/notifications)** — 第一时间知道智能体何时完成或需要关注，并可将会话标记为未读，稍后再回来处理。
...
适配**任何 CLI 智能体** — 只要能在终端里运行，就能在 Dorka 里运行。
...
- **[从 onDorka.dev 下载](https://ondorka.dev/download)**
- 或直接获取安装包：[macOS Apple Silicon](https://github.com/stablyai/orca/releases/latest/download/dorka-macos-arm64.dmg) · [macOS Intel](https://github.com/stablyai/orca/releases/latest/download/dorka-macos-x64.dmg) · [Windows (.exe)](https://github.com/stablyai/orca/releases/latest/download/dorka-windows-setup.exe) · [Linux AppImage](https://github.com/stablyai/orca/releases/latest/download/dorka-linux.AppImage) · [全部构建](https://github.com/stablyai/orca/releases/latest)
...
- **iOS:** [从 App Store 下载](https://apps.apple.com/us/app/dorka-ide/id6766130217)
...
- **Twitter / X:** 关注 **[@dorka_build](https://x.com/dorka_build)** 获取更新和公告。
- **微信:** 扫码加入 Dorka 社区微信第 10 群。

  <img src="../assets/wechat-qr-group10.jpg" alt="Dorka 社区微信第 10 群二维码" width="160" />

- **反馈与想法:** 我们发布很快。缺少什么功能？[提交功能请求](https://github.com/stablyai/orca/issues)。
- **隐私:** 查看[隐私与遥测文档](https://www.ondorka.dev/docs/telemetry)，了解 Dorka 收集哪些匿名使用数据以及如何退出。
...
<a href="https://github.com/stablyai/orca/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=stablyai/orca" alt="Dorka 贡献者" />
</a>

## 许可证

Dorka 是自由且开源的软件，遵循 [MIT 许可证](../../LICENSE)。
