...
const POPULAR_SEARCHES: {
  ...
  {
    breadcrumb: ['Documentation', 'The Dorka Model', 'Worktrees'],
    title: 'Worktrees',
    description:
  ...
  },
  {
    ...
    title: 'Design Mode',
    description:
      'Click any UI element in the Dorka browser — its HTML, computed styles, and screenshot drop straight into the agent chat.',
  ...
  },
  {
    ...
    description:
      "Dorka reads each repo's .claude/ and .codex/ config, runs your hooks on worktree create, and surfaces CLAUDE.md / AGENTS.md inline.",
  ...
  },
  {
    ...
    description:
      'Point Dorka at any SSH target — a dev box, a GPU host, a cloud sandbox — and open remote repos or just folders. Same editor, same diff view, different compute.',
