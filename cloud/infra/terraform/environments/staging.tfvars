project_id  = "ondorka-cloud-staging"
environment = "staging"
name_prefix = "dorka-cloud-staging"
region      = "us-central1"
...
auth_base_url = "https://auth-staging.ondorka.dev"

relay_cloud_run_service_name          = "dorka-cloud-relay-staging"
relay_staging_power_auth_service_name = "dorka-cloud-auth-staging"
relay_base_url                        = "https://relay-staging.ondorka.dev"
...
# c1.relay-staging.ondorka.dev. Cloudflare records remain out-of-band.
relay_gce_domain          = "relay-staging.ondorka.dev"
...
relay_gce_cells = {
  "staging-gce-c1" = {
    ...
    image             = "us-central1-docker.pkg.dev/ondorka-cloud-staging/dorka-cloud/relay@sha256:2d0f6e6db2b0eb9d6aba188698de8330f8c30b4e76badfcf0fac3f3eb9508a87"
  }
  "staging-gce-c2" = {
    hostname                    = "c2"
    zone                        = "us-central1-c"
    ...
    boot_image                  = "https://www.googleapis.com/compute/v1/projects/cos-cloud/global/images/cos-stable-121-18867-528-7"
    capacity_requests           = 4000
    image                       = "us-central1-docker.pkg.dev/ondorka-cloud-staging/dorka-cloud/relay@sha256:1239830d0946dc92ded3c9edde1c0b827f584a7a2be5c177beed900056d76f69"
  ...
  "staging-gce-c3" = {
    ...
    boot_image                  = "https://www.googleapis.com/compute/v1/projects/cos-cloud/global/images/cos-stable-121-18867-528-7"
    capacity_requests           = 4000
    image                       = "us-central1-docker.pkg.dev/ondorka-cloud-staging/dorka-cloud/relay@sha256:5aedbca5c86de24c8b4d4bf7e3b444b76c712f281ede916cb9d90f70cad1e563"
