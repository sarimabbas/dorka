 ...
 * optional at every read (:283 spells `uiState?.trustedDorkaHooks ?? {}`, :284
 ...
 * opaque forwards: `trustedDorkaHooks` goes straight into state, and `taskResumeState` is the
  ...
  .looseObject({
    ui: salvagedOptional(
      ...
      z.looseObject({
        ...
        trustedDorkaHooks: z.unknown().optional()
      })
    )
  })
  .nullish()
