...
const PER_ACCOUNT_HOME = '/Users/ada/Library/Application Support/dorka/codex-accounts/a/home'
...
describe('prepareMobileAiVaultSessionResume', () => {
  ...
  it('uses the real Codex home when a supported desktop requests it', async () => {
    ...
    expect(launch.envToDelete).toEqual(['CODEX_HOME', 'DORKA_CODEX_HOME'])
  })
  ...
  it('repins a per-account session to the home the host substitutes', async () => {
    const substituteHome = '/Users/ada/Library/Application Support/dorka/codex-accounts/b/home'
