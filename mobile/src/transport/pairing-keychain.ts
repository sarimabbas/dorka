...
const GENERATION_STORAGE_KEY = 'dorka:pairing-keychain-generation'
const PRESENCE_STORAGE_PREFIX = 'dorka:pairing-keychain-presence:'
const SERVICE_PREFIX = 'dorka.pairing.v'
