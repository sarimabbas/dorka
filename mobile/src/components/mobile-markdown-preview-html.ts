...
const escapedHtmlEntityTokens = [
  { pattern: /&amp;nbsp;/gi, token: '\uE000DORKA_MD_ENTITY_NBSP\uE000', value: '&nbsp;' },
  { pattern: /&amp;lt;/gi, token: '\uE000DORKA_MD_ENTITY_LT\uE000', value: '&lt;' },
  { pattern: /&amp;gt;/gi, token: '\uE000DORKA_MD_ENTITY_GT\uE000', value: '&gt;' },
  { pattern: /&amp;quot;/gi, token: '\uE000DORKA_MD_ENTITY_QUOT\uE000', value: '&quot;' },
  { pattern: /&amp;#39;/gi, token: '\uE000DORKA_MD_ENTITY_APOS\uE000', value: '&#39;' },
  { pattern: /&lt;/gi, token: '\uE000DORKA_MD_ENTITY_RAW_LT\uE000', value: '<' },
  { pattern: /&gt;/gi, token: '\uE000DORKA_MD_ENTITY_RAW_GT\uE000', value: '>' }
] as const
...
const CODE_PLACEHOLDER_PREFIX_BASE = '\uE000DORKA_MD_CODE_'
