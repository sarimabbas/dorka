 ...
 */
export type DorkaBridgePageChannel = {
 ...
 */
export function readDorkaBridgePageChannel(): DorkaBridgePageChannel | null {
  const scope: typeof globalThis & { dorkaBridge?: DorkaBridgePageChannel } = globalThis
  const channel = scope.dorkaBridge
 ...
 */
export function createDorkaBridgePageTransport(
  channel: DorkaBridgePageChannel
