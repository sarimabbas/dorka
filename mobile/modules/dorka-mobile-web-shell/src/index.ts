...
export type DorkaMobileWebShellViewProps = ViewProps & {
  /**
  ...
  /**
   * The page posted `json` through `window.dorkaBridge`. Native has already refused anything from
...
export type DorkaMobileWebShellViewHandle = {
  /**
 ...
 */
export const DorkaMobileWebShellView: ComponentType<
  DorkaMobileWebShellViewProps & RefAttributes<DorkaMobileWebShellViewHandle>
