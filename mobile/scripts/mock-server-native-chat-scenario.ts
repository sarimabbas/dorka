...
const SEND_MODE_FILE = process.env.MOCK_SEND_MODE_FILE ?? join(tmpdir(), 'dorka-mock-send-mode')
const TERMINAL_LIST_MODE_FILE =
  process.env.MOCK_TERMINAL_LIST_MODE_FILE ?? join(tmpdir(), 'dorka-mock-terminal-list-mode')
...
const TERMINAL_STREAM_MODE_FILE =
  process.env.MOCK_TERMINAL_STREAM_MODE_FILE ?? join(tmpdir(), 'dorka-mock-terminal-stream-mode')
